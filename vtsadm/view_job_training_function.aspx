<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_job_training_function.aspx.cs" Inherits="vtsadm.view_job_training_function" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="hidden" id="txtTrainID" runat="server" />
                <input type="text" id="txtSearchFunc" runat="server" class="form-control" placeholder="Search by any fields ..." />
                ...
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Yes" HeaderStyle-CssClass="gv-header-center">
                            <ItemTemplate>
                                <asp:RadioButton ID="RdoYes" runat="server" Checked="false" GroupName="Check" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="No" HeaderStyle-CssClass="gv-header-center">
                            <ItemTemplate>
                                <asp:RadioButton ID="RdoNo" runat="server" Checked="false" GroupName="Check" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="isYes" HeaderText="isYes" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="isNo" HeaderText="isNo" ItemStyle-Wrap="false"></asp:BoundField>

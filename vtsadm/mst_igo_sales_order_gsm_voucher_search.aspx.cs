...
namespace vtsadm
{
    public partial class mst_igo_sales_order_gsm_voucher_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_igo_master_order_gsm_voucher_search '" + sName + "'";
        ...
        protected void CmdSearchStock_ServerClick(object sender, EventArgs e)
        {
            try
            {
                Open_GridViewStock(txtSearchJobOrder.Value.Trim());
            }
            catch (Exception ex)
            {

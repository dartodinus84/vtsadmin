...
namespace vtsadm
{
    public partial class device_setup_gsm_search : System.Web.UI.Page
    {
        ...
        private void Open_GridViewGsm(string sMSIDN)
        {
            Recordset Rec = new Recordset();
            string strSQL = "sp_list_device_setup_gsm_search '" + sMSIDN + "'";
            Rec.Open(strSQL, Session["ClsTypeDBConnStringSQL"].ToString());
            GridView1.DataSource = Rec.DataRecord();
            GridView1.DataBind();
            Session["RecListDeviceSetupGsmSearch"] = Rec.RecData;
        }
        protected void GridView1_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            (sender as GridView).DataSource = Session["RecListDeviceSetupGsmSearch"];

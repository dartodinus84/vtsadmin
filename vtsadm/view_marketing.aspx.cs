...
namespace vtsadm
{
    public partial class view_marketing : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewMarketingFieldSort";
        string sViewStateDirSort = "RecViewMarketingDirSort";
        string sSessionRecList = "RecViewMarketing";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_master_marketing '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "MarketingName";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWMSTMKT"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewMarketing"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Marketing", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_po_jo.aspx.cs" Inherits="vtsadm.rpt_po_jo" EnableEventValidation="false" %>
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="PoID" HeaderText="Po ID Number" ItemStyle-Wrap="false" SortExpression="PoID"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="QtyPO" HeaderText="Qty" ItemStyle-Wrap="false" SortExpression="QtyPO"></asp:BoundField>
                                         <asp:BoundField DataField="JobID" HeaderText="JO ID" ItemStyle-Wrap="false" SortExpression="JobID"></asp:BoundField>
                                        <asp:BoundField DataField="Quantity" HeaderText="Qty JO" ItemStyle-Wrap="false" SortExpression="Quantity"></asp:BoundField>
                                       <asp:BoundField DataField="QtyDone" HeaderText="Qty JR" ItemStyle-Wrap="false" SortExpression="QtyDone"></asp:BoundField>
                                       
                                       
                                        <%--<asp:BoundField DataField="PoID" HeaderText="PO ID" ItemStyle-Wrap="false" SortExpression="PoID"></asp:BoundField>
                                        <asp:BoundField DataField="PoTypeDesc" HeaderText="TYPE" ItemStyle-Wrap="false" SortExpression="PoTypeDesc"></asp:BoundField>
                                        <asp:BoundField DataField="QtyPO" HeaderText="QTY" ItemStyle-Wrap="false" SortExpression="QtyPO"></asp:BoundField>
                                        <asp:BoundField DataField="JobID" HeaderText="JO ID" ItemStyle-Wrap="false" SortExpression="JobID"></asp:BoundField>
                                        <asp:BoundField DataField="Quantity" HeaderText="QTY JO" ItemStyle-Wrap="false" SortExpression="Quantity"></asp:BoundField>
                                        <asp:BoundField DataField="QtyDoneJO" HeaderText="QTY JR" ItemStyle-Wrap="false" SortExpression="QtyDoneJO"></asp:BoundField>
                                        --%>
                                    </Columns>

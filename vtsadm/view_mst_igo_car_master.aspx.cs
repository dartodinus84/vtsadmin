...
namespace vtsadm
{
    public partial class view_mst_igo_car_master : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewCarMasterFieldSort";
        string sViewStateDirSort = "RecViewCarMasterDirSort";
        string sSessionRecList = "RecViewCarMaster";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "usp_retail_car_master '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "exp_date";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWIGOCR"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewCarMaster"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Expired Voucher and GSM", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

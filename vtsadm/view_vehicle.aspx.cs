...
namespace vtsadm
{
    public partial class view_vehicle : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewVehicleFieldSort";
        string sViewStateDirSort = "RecViewVehicleDirSort";
        string sSessionRecList = "RecViewVehicle";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_master_vehicle '" + Session["ClsTypeUserTechnicianID"].ToString() + "','" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWMSTVEH"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewVehicle"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Vehicle", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

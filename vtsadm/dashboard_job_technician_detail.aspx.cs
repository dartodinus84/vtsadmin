...
namespace vtsadm
{
    public partial class dashboard_job_technician_detail : System.Web.UI.Page
    {
        ...
        protected void Open_GridView(string type, string branchid, string from, string to, string areaid)
        {
            try
            {

                ClsType ClType = new ClsType();
                string strSQL = "sp_dashboard_job_technician_detail '" + type + "', '" + branchid + "','" + areaid + "','" + from + "','" + to + "'";
                ...
                if (!IsPostBack)
                {
                    if (Session["ClsTypeIsLogin"] != null)
                    {
                        if (ClType.SudahLogon(Convert.ToBoolean(Session["ClsTypeIsLogin"])))
                        {
                            ...
                            Open_GridView(type, branchid, from, to, areaid);
        ...
        protected void CmdSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string branchid = Session["ClsPicCustDetail"].ToString();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="auth_group.aspx.cs" Inherits="vtsadm.auth_group" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Group Authentication  
                <small>Input</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:DropDownList ID="CmbGroupID" runat="server" AutoPostBack="true" OnTextChanged="CmbGroupID_TextChanged" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>

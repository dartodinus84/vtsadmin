<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_vendor_list_device.aspx.cs" Inherits="vtsadm.view_vendor_list_device" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                ...
                <input type="text" id="txtSearchDevice" runat="server" class="form-control" placeholder="Search by any fields ..."/>
                <span class="input-group-btn">
                    <button id="CmdSearchDevice" runat="server" type="button" class="btn btn-block btn-primary btn-xs" onserverclick="CmdSearchDevice_ServerClick"><i class="fa fa-search"></i></button>
                </span>
            </div>                    
        </div>	    
        <div class="form-group form-group-sm">

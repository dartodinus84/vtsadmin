<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_job_maint_gsms.aspx.cs" Inherits="vtsadm.rpt_job_maint_gsms" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order - Maintenance - Gsm 
                <small>Report</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ProviderID" HeaderText="Provider Name" ItemStyle-Wrap="false" SortExpression="ProviderID"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="MSIDN_Old" HeaderText="No MSIDN Old" ItemStyle-Wrap="false" SortExpression="NoMSIDN_Old"></asp:BoundField>
                                        <asp:BoundField DataField="ProviderID_Old" HeaderText="Provider Name Old" ItemStyle-Wrap="false" SortExpression="ProviderID_Old"></asp:BoundField>

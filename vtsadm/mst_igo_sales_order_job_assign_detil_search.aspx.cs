...
namespace vtsadm
{
    public partial class mst_igo_sales_order_job_assign_detil_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_igo_master_job_assign_detil '" + txtOrderID.Value.Trim() + "','" + sName + "'";

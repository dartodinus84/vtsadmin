<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_mutation_po_approve.aspx.cs" Inherits="vtsadm.view_mutation_po_approve" EnableEventValidation="false" %>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete request SO ID :&nbsp;</h6>
        ...
        <div class="modal fade" id="modal-approve">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to Approve SO ID :&nbsp;</h6>

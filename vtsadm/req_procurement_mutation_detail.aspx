<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="req_procurement_mutation_detail.aspx.cs" Inherits="vtsadm.req_procurement_mutation_detail" %>
...
<body>
    <form id="form1" runat="server">
        <div class="box-body">
            ...
            <div class="form-group form-group-sm">
                <label>Remarks</label>
                <asp:TextBox ID="txtRemarks" runat="server" class="form-control" placeholder="Quantity Detail ..."></asp:TextBox>
            </div>

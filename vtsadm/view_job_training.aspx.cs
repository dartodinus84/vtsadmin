...
namespace vtsadm
{
    public partial class view_job_training : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewJobTrainingFieldSort";
        string sViewStateDirSort = "RecViewJobTrainingDirSort";
        string sSessionRecList = "RecViewJobTraining";
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_job_training '" + txtSearch.Text.Trim() + "','" + filterType + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "TrainingID";
        ...
        private void clear()
        {
            ...
            {
                ClsType ClType = new ClsType();
                ClType.Open_Combos(CmbFilterType, Session["ClsTypeDBConnStringSQL"].ToString(), "", "sp_list_jobtraining_filter");
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Job Training", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    LinkButton CmdRemarks = (LinkButton)e.Row.FindControl("CmdRemarks");
                    CmdRemarks.OnClientClick = "postRemarks('" + e.Row.Cells[0].Text.ToString() + "'); return false;";

                    LinkButton CmdFunc = (LinkButton)e.Row.FindControl("CmdFunc");
                    CmdFunc.OnClientClick = "postFunc('" + e.Row.Cells[18].Text.ToString() + "'); return false;";

                    LinkButton CmdPic = (LinkButton)e.Row.FindControl("CmdPic");
                    CmdPic.OnClientClick = "postPic('" + e.Row.Cells[24].Text.ToString() + "'); return false;";

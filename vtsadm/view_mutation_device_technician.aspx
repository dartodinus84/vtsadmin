<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_mutation_device_technician.aspx.cs" Inherits="vtsadm.view_mutation_device_technician" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="hidden" id="txtDeviceID" runat="server" />
                <input type="text" id="txtSearchLog" runat="server" class="form-control" placeholder="Search by any fields ..." />
                <span class="input-group-btn">
                    <button id="CmdSearchLog" runat="server" type="button" class="btn btn-block btn-primary btn-xs" onserverclick="CmdSearchLog_ServerClick"><i class="fa fa-search"></i></button>
                </span>
            </div>
        </div>
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DeviceTypeDesc" HeaderText="Type" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="WarehouseName" HeaderText="Warehouse" ItemStyle-Wrap="false"></asp:BoundField>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_job_create_open.aspx.cs" Inherits="vtsadm.view_job_create_open" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order - New (Open)
                <small>View</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Job Order - New (Open)</h3>
                    </div>
                    <div class="box-body">
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="10" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="AreaGroupName" HeaderText="Area Group Name" ItemStyle-Wrap="false" SortExpression="AreaGroupName"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Quantity" HeaderText="Total Quantity" ItemStyle-Wrap="false" SortExpression="Quantity"></asp:BoundField>
                                        <asp:BoundField DataField="QuantityDone" HeaderText="Total Quantity Done" ItemStyle-Wrap="false" SortExpression="QuantityDone"></asp:BoundField>
                                        <asp:BoundField DataField="QuantityGPS" HeaderText="GPS Quantity Target" ItemStyle-Wrap="false" SortExpression="QuantityGPS"></asp:BoundField>
                                        <asp:BoundField DataField="QuantityGPSDone" HeaderText="GPS Quantity Done" ItemStyle-Wrap="false" SortExpression="QuantityGPSDone"></asp:BoundField>
                                        <asp:BoundField DataField="QuantityACS" HeaderText="ACS Quantity Target" ItemStyle-Wrap="false" SortExpression="QuantityACS"></asp:BoundField>
                                        <asp:BoundField DataField="QuantityACSDone" HeaderText="ACS Quantity Done" ItemStyle-Wrap="false" SortExpression="QuantityACSDone"></asp:BoundField>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-jobdone">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">List Job Order Done</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframejobdone" src="view_job_order_create_done.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">List Job Order New Details</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframejobdetails" src="view_job_order_create_details.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <asp:Button ID="CmdExportDetails" CssClass="btn btn-primary" runat="server" OnClick="CmdExportDetails_Click" Text="Export CSV" />
                        <asp:Button ID="CmdExportDetailsXls" CssClass="btn btn-primary" runat="server" OnClick="CmdExportDetailsXls_Click" Text="Export XSL" />
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Job Order New Details</h4>
                    </div>
    ...
    <style>
        .total-col { background-color: #e0f0ff !important; }
        .gps-col { background-color: #e6f9e6 !important; }
        .acs-col { background-color: #fff9e0 !important; }
    </style>
    <script type="text/javascript">
        ...
        function postJobOrderDone(sJobID) {
            if (sJobID != '') {
                var objfr = document.getElementById('iframejobdone').contentWindow;
        ...
        function postDetails(sJobID, sRegDate, sCustomerName, sPONumber, sSchDate, sBillable, sIsMigrationDesc, sStatus, objDetails, objJobDetails, objJobDone,

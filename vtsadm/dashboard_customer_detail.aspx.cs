...
namespace vtsadm
{
    public partial class dashboard_customer_detail : System.Web.UI.Page
    {
        ...
        protected void Open_GridView(string type)
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_mst_customer '" + Session["ClsTypeUserGroupID"].ToString() + "', '" + Session["ClsTypeUserID"].ToString() + "','0','" + type + "'";

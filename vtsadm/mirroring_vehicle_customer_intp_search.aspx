<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mirroring_vehicle_customer_intp_search.aspx.cs" Inherits="vtsadm.mirroring_vehicle_customer_intp_search" %>
        ...
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:BoundField DataField="intp_company_id" HeaderText="Company ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="intp_company_nm" HeaderText="Company Name" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="intp_company_addr" HeaderText="Company Address" ItemStyle-Wrap="false"></asp:BoundField>

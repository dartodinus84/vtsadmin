...
namespace vtsadm
{
    public partial class dashboard_jo : System.Web.UI.Page
    {
        protected void open_dashboard_data()
        {
            try
            {
                ...
                string GroupAreaName = Session["SessionGroupAreaName"].ToString();
                string dateFrom = Session["SessionDateFrom"].ToString();
                string dateTo = Session["SessionDateTo"].ToString();

                string strSQL = "sp_dashboard_jo '" + filterType + "','" + GroupAreaName + "','" + dateFrom + "','" + dateTo + "'";
        ...
        protected void jo_dashboard_new()
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_jo_status 'NEW','" + filterType + "','" + GroupAreaName + "','" + dateFrom + "','" + dateTo + "'";
                Rec.Open(strSQL, Session["ClsTypeDBConnStringSQL"].ToString());
                if (Rec.RecordCount() > 0)
                {
        ...
        protected void jo_dashboard_maint()
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_jo_status 'MAINTENANCE','" + filterType + "','" + GroupAreaName + "','" + dateFrom + "','" + dateTo + "'";
                Rec.Open(strSQL, Session["ClsTypeDBConnStringSQL"].ToString());
                if (Rec.RecordCount() > 0)
                {
        ...
        protected void jo_dashboard_unit()
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_jo_status 'UNIT','" + filterType + "','" + GroupAreaName + "','" + dateFrom + "','" + dateTo + "'";
                Rec.Open(strSQL, Session["ClsTypeDBConnStringSQL"].ToString());
                if (Rec.RecordCount() > 0)
                {
        ...
        protected void Clear()
        {
            try
            {
                ...
                CmbGroupAreaName.SelectedValue = "[Select]";
    ...
    public class DataWarehouseDevice2
    {
    ...
    public class DataTechnicianDevice2
    {

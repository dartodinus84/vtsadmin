...
namespace vtsadm
{
    public partial class job_assign_details : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                sAreaID = Session["ClsAreaID"].ToString();
                string strSQL = "sp_list_technician_assign_detail '" + txtSearch.Text.Trim() + "','" + txtScheduleDate.Value.Trim() + "','" + sAreaID.Trim() + "'";

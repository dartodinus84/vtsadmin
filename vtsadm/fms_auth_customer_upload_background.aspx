<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fms_auth_customer_upload_background.aspx.cs" Inherits="vtsadm.fms_auth_customer_upload_background" %>
                ...
                <div class="box box-solid" style="background-color: #f7f7f7;">
                    <div class="box-body">
                        <div id="divpic" class="form-group form-group-sm" style="height:195px;text-align:center;">                            
                            <asp:Image ID="ImgInstall" runat="server" BorderWidth="0px" height="100%" Width="100%"/>
                        </div>
                    </div>
                </div>
            </div>

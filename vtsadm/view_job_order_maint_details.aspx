<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_job_order_maint_details.aspx.cs" Inherits="vtsadm.view_job_order_maint_details" %>
            ...
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MaintTypeDesc" HeaderText="Maint Type" ItemStyle-Wrap="false"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="TechnicianName" HeaderText="Technician" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="ValueStatus" HeaderText="Status" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="UsrUpdJob" HeaderText="User Update" ItemStyle-Wrap="false"></asp:BoundField>

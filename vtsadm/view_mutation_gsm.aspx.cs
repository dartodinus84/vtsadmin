...
namespace vtsadm
{
    public partial class view_mutation_gsm : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_mutation_gsm '" + Session["ClsTypeUserTechnicianID"].ToString() + "','" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ((SiteMaster)this.Page.Master).RegisterPostBackTrigger(CmdExportWarehouseXls);
                ((SiteMaster)this.Page.Master).RegisterPostBackTrigger(CmdExportTechnicianXls);
                if (!IsPostBack)
                {
        ...
        protected void CmdExportWarehouseXls_Click(object sender, EventArgs e)
        {
            try
            {
                //ClsType clType = new ClsType();
        ...
        protected void CmdExportTechnicianXls_Click(object sender, EventArgs e)
        {
            try
            {
                //ClsType clType = new ClsType();

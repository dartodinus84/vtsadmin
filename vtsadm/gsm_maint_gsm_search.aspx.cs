...
namespace vtsadm
{
    public partial class gsm_maint_gsm_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_gsm_maint_gsm_search '" + txtCustID.Value.Trim() + "','" + txtJobID.Value.Trim() + "','" + sSearch + "'";

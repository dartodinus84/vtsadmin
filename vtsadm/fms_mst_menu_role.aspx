<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fms_mst_menu_role.aspx.cs" Inherits="vtsadm.fms_mst_menu_role" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            <label>Role ID</label>
                            <asp:TextBox ID="txtRoleID" runat="server" class="form-control" placeholder="Role ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Role Name</label>
                            <asp:TextBox ID="txtRoleName" runat="server" class="form-control" placeholder="Role Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Menu Role</h3>
                        <div class="box-tools" style="width: 180px;">
                            <div class="input-group input-group-sm">
                                <asp:TextBox ID="txtSearch" runat="server" class="form-control pull-right" placeholder="Search by Role Name ..."></asp:TextBox>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RoleID" HeaderText="Role ID" ItemStyle-Wrap="false" SortExpression="RoleID"></asp:BoundField>
                                        <asp:BoundField DataField="RoleName" HeaderText="Role Name" ItemStyle-Wrap="false" SortExpression="RoleName"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Role ID :&nbsp;</h6><label id="LblRoleIDDelete" runat="server"></label>&nbsp;?
                        <input type="hidden" id="txtRoleIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(roleID, status) {
            if (roleID != '') {
                document.getElementById('ContentPlaceHolder1_LblRoleIDDelete').innerHTML = roleID;
                document.getElementById('ContentPlaceHolder1_txtRoleIDDelete').value = roleID;
                document.getElementById('ContentPlaceHolder1_txtStatusDelete').value = status;

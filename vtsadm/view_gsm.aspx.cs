...
namespace vtsadm
{
    public partial class view_gsm : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewGsmFieldSort";
        string sViewStateDirSort = "RecViewGsmDirSort";
        string sSessionRecList = "RecViewGsm";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_master_gsm '" + Session["ClsTypeUserTechnicianID"].ToString() + "','" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "MSIDN";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWMSTGSM"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewGsm"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Gsm", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="provider.aspx.cs" Inherits="vtsadm.provider" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtProvID" runat="server" class="form-control" placeholder="Provider ID ..." required="required" disabled="" ></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Provider Name</label>
                            <asp:TextBox ID="txtProvName" runat="server" class="form-control" placeholder="Provider Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Provider</h3>
                        <div class="box-tools" style="width: 150px;">
                            <div class="input-group input-group-sm">
                                <asp:TextBox ID="txtSearch" runat="server" class="form-control pull-right" placeholder="Search by provider name ..."></asp:TextBox>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Provider ID :&nbsp;</h6>
                        <label id="LblProviderID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtProviderIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblProviderID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtProviderIDDelete').value = sText;

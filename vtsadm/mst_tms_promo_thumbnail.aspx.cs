...
namespace vtsadm
{
    public partial class mst_tms_promo_thumbnail : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                ...
                {
                    ImgInstall.ImageUrl = "~/Picture/tms/promo/thumbnail/" + Session["ClsTypePromoTMSThumbnail"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 4) == "JPEG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "PNG")
                    {
                        ...
                        string strFullPathThumb = Server.MapPath("~/picture/tms/promo/thumbnail/") + strFileName;
                        ...
                        Session["ClsTypePromoTMSThumbnail"] = "https://vtsadmin.easygo-gps.co.id/picture/tms/promo/thumbnail/" + strFileName;

                        lblMsg.InnerHtml = "<strong>Success!</strong>";

                        //string strFileName = ClsFunc.Left(FileUpload1.FileName, (FileUpload1.FileName.Length - 4)) + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".jpg";
                        //string strFullPath = Server.MapPath("~/Picture/tms/promo/thumbnail/") + strFileName;
                        //FileUpload1.SaveAs(strFullPath);
                        //ImgInstall.ImageUrl = "~/Picture/tms/promo/thumbnail/" + strFileName;

...
namespace vtsadm
{
    public partial class fms_auth_customer_upload : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                if (Session["ClsTypeFMSCustomerLogo"].ToString() != "")
                {
                    ImgInstall.ImageUrl = "~/Picture/" + Session["ClsTypeFMSCustomerLogo"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "PNG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 4) == "PNG")
                    {
                        ...
                        Session["ClsTypeFMSCustomerLogo"] = strFileName;

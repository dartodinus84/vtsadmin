...
namespace vtsadm
{
    public partial class rpt_job_maint_gsm : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_job_maint_gsm_group_area '" + txtSearch.Text.Trim() + "','" + CmbGroupAreaID.SelectedItem.Value.ToString() + "', '" + CmbAreaID.SelectedItem.Value.ToString() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";

...
namespace vtsadm
{
    public partial class device_mutation_readycheck_device_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_device_mutation_readycheck_device_search '" + sSearch + "'";

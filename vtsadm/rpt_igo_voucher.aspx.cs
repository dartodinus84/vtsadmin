...
namespace vtsadm
{
    public partial class rpt_igo_voucher : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptMstVouFieldSort";
        string sViewStateDirSort = "RecRptMstVouDirSort";
        string sSessionRecList = "RecRptMstVou";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_igo_master_voucher '" + txtSearch.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "voucher_id";

...
namespace vtsadm
{
    public partial class so_create : System.Web.UI.Page
    {
                    ...
                    if (txtPoDate.Text.Trim() != "")
                    {
                        if (txtPoNumber.Text.Trim() != "")
                        {
                            if (CmbPoType.SelectedItem.Value.Trim() != "[Select]")
                            {
                                ...
                                strSQL = "sp_insert_purchase_order_header '" + txtCustID.Value.Trim() + "','" + txtPoDate.Text.Trim() + "','" + txtPoNumber.Text.Trim() + "','" + CmbPoType.SelectedItem.Value.Trim() + "','" + txtContractTime.Value.Trim() + "','" + txtRemark.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";

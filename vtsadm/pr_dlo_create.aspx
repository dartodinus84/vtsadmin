<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pr_dlo_create.aspx.cs" Inherits="vtsadm.pr_dlo_create" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>BAST
            <small>Berita Acara Serah Terima - Create</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Informasi Purchase Request</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>PO ID</label>
                            <div class="input-group input-group-sm">
                                <input type="text" id="txtPurIDView" runat="server" class="form-control" placeholder="Pilih PUR ..." readonly="readonly" />
                                <span class="input-group-btn">
                                    <button id="Button2" runat="server" type="button" class="btn btn-block btn-primary btn-xs" data-toggle="modal" data-target="#modal-pur"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                            <asp:HiddenField ID="txtVendorID" runat="server" Value="" />
                        </div>
                        <div class="form-group form-group-sm">
                            <label>PO Number</label>
                            <asp:TextBox ID="txtPurNumber" runat="server" class="form-control" placeholder="PUR Number ..." ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>PO Date</label>
                            <asp:TextBox ID="txtPurDate" runat="server" class="form-control" placeholder="PUR Date ..." ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Vendor</label>
                            <asp:TextBox ID="txtVendorName" runat="server" class="form-control" placeholder="Vendor ..." ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <asp:Panel ID="PanelListDetail" runat="server" Visible="false">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Detail BAST</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="DloID" HeaderText="BAST ID" ItemStyle-Wrap="false" SortExpression="DloID"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="QuantityDone" HeaderText="Qty Serah Terima" ItemStyle-Wrap="false" SortExpression="QuantityDone"></asp:BoundField>
                                        <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Wrap="false" SortExpression="Status"></asp:BoundField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="CmdDeviceDetail" runat="server" Text="<i class='fa fa-barcode'></i>" ToolTip="Input Device SN" Enabled="true" CssClass="btn btn-info btn-xs" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Informasi BAST</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>BAST ID</label>
                            <asp:TextBox ID="txtDloID" runat="server" class="form-control" placeholder="Skip for BAST baru ..." disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Tanggal BAST</label>
                            <asp:TextBox ID="txtDloDate" TextMode="Date" runat="server" class="form-control" placeholder="Tanggal BAST ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>No. BAST</label>
                            <asp:TextBox ID="txtDloNumber" runat="server" class="form-control" placeholder="No. BAST ..."></asp:TextBox>
                        </div>
                        ...
                        <asp:HiddenField ID="txtPurID" runat="server" Value="" />
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List BAST</h3>
                        <div class="box-tools">
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowEditing="GridView1_RowEditing" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnSorting="GridView1_Sorting" >
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <Columns>
                                        <asp:BoundField DataField="DloID" HeaderText="BAST ID" ItemStyle-Wrap="false" SortExpression="DloID" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="DloDate" HeaderText="Tanggal BAST" ItemStyle-Wrap="false" SortExpression="DloDate" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="DloNumber" HeaderText="No. BAST" ItemStyle-Wrap="false" SortExpression="DloNumber" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="VendorName" HeaderText="Vendor" ItemStyle-Wrap="false" SortExpression="VendorName" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="WarehouseName" HeaderText="Warehouse" ItemStyle-Wrap="false" SortExpression="WarehouseName" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="PurID" HeaderText="PO ID" ItemStyle-Wrap="false" SortExpression="PurID" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="Remark" HeaderText="Remark" ItemStyle-Wrap="false" SortExpression="Remark" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Wrap="false" SortExpression="Status" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="UsrUpd" HeaderText="Usr Upd" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField DataField="DtmUpd" HeaderText="Dtm Upd" ItemStyle-Wrap="false"></asp:BoundField>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="CmdDelete" runat="server" Text="&lt;i class='fa fa-close'&gt;&lt;/i&gt;" ToolTip="Delete BAST" CssClass="btn btn-danger btn-xs" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <RowStyle ForeColor="#003481" BackColor="White" />
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Yakin akan submit DLO ID :&nbsp;</h6><label id="LblPurIDSubmit" runat="server"></label>&nbsp;?
                    </div>
        ...
        <div class="modal fade" id="modal-delete-header">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Yakin akan hapus DLO ID :&nbsp;</h6><label id="LblPurID" runat="server"></label>&nbsp;?
                        <input type="hidden" id="txtPurIDDelete" runat="server" />
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-pur">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="pr_dlo_create_pr_select.aspx" style="width: 100%; border: none; height: 350px;" overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal modal-open fade" id="modal-details" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframedetails" src="pr_dlo_create_details.aspx" style="width: 100%; border: none; height: 415px; overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.modal-content -->
        ...
        <div class="modal modal-open fade" id="modal-device-details" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Input Device SN</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframedevice" src="pr_dlo_create_details_device.aspx" style="width: 100%; border: none; height: 480px; overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    <script type="text/javascript">
        ...
        function postPrChild(sPurID, sPurNumber, sPurDate, sVendorName, sVendorID) {
            if (sPurID != '') {
                document.getElementById('ContentPlaceHolder1_txtVendorID').value = sVendorID || '';
                document.getElementById('ContentPlaceHolder1_txtPurIDView').value = sPurID || '';
                document.getElementById('ContentPlaceHolder1_txtPurNumber').value = sPurNumber || '';
                document.getElementById('ContentPlaceHolder1_txtPurDate').value = sPurDate || '';
                document.getElementById('ContentPlaceHolder1_txtVendorName').value = sVendorName || '';
                var purIdHidden = document.getElementById('ContentPlaceHolder1_txtPurID');
                if (purIdHidden) purIdHidden.value = sPurID;
                $('#modal-pur').modal('hide');
            }
        }

        function showDetails() {
            var dloIdEl = document.getElementById('ContentPlaceHolder1_txtDloID');
            var purIdEl = document.getElementById('ContentPlaceHolder1_txtPurID');
            if (dloIdEl && dloIdEl.value != '' && purIdEl && purIdEl.value != '') {
                var objfr = document.getElementById("iframedetails").contentWindow;
                var objDloID = objfr.document.getElementById("txtDloID");
                var objPurID = objfr.document.getElementById("txtPurID");
                var cmdClear = objfr.document.getElementById("Button1");
                if (objDloID) objDloID.value = dloIdEl.value;
                if (objPurID) objPurID.value = purIdEl.value;
                if (cmdClear) cmdClear.click();
        ...
        function showDeviceDetails(dloId, seq) {
            if ((dloId || '') !== '' && (seq || '') !== '') {
                var iframe = document.getElementById("iframedevice");
                if (iframe) {
                    iframe.src = "pr_dlo_create_details_device.aspx?DloID=" + encodeURIComponent(dloId) + "&Seq=" + encodeURIComponent(seq);
                }
        ...
        function confirmSubmit() {
            var objDloID = document.getElementById('ContentPlaceHolder1_txtDloID');
            if (objDloID && objDloID.value != '') {
                document.getElementById('ContentPlaceHolder1_LblPurIDSubmit').innerHTML = objDloID.value;
        ...
        function confirmDelete(sPurID, sStatus) {
            if (sPurID != '') {
                document.getElementById('ContentPlaceHolder1_LblPurID').innerHTML = sPurID;
                document.getElementById('ContentPlaceHolder1_txtPurIDDelete').value = sPurID;
        ...
        function endRequest(sender, args) {
            $('#modal-details').on('hidden.bs.modal', function () {
                ...
                if (objLoad) objLoad.click();
            });
            $('#modal-device-details').on('hidden.bs.modal', function () {
                var objLoad = document.getElementById('ContentPlaceHolder1_CmdLoad');
                if (objLoad) objLoad.click();
            });
            ...
            var isExists = document.getElementById('ContentPlaceHolder1_div_comment');
            if (isExists && isExists.innerHTML != '') {
                $('#modal-messagebox').modal('show');
            }
        }
        endRequest();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="dashboard_job_list_installation.aspx.cs" Inherits="vtsadm.dashboard_job_list_installation" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>
            <asp:Label ID="lblHeaderTitle" runat="server" Text="New Installation - All"></asp:Label>
            <small>List</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="dashboard_job.aspx">Dashboard - Job Order</a></li>
            <li class="active">New Installation List</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <p style="margin-bottom: 6px;"><strong><asp:Label ID="lblContextStatus" runat="server" Text="New Installation - All"></asp:Label></strong></p>
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Job Installation</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="gvInstallation" runat="server" BackColor="WhiteSmoke" AllowSorting="false" Font-Size="Small"
                                    ...
                                    AllowPaging="true" PageSize="10" OnPageIndexChanging="gvInstallation_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PoTypeDesc" HeaderText="PO Type" />
                                        <asp:BoundField DataField="MarketingName" HeaderText="Marketing" />
                                        <asp:BoundField DataField="Quantity" HeaderText="Total Quantity" />
                                        <asp:BoundField DataField="QuantityDone" HeaderText="Total Quantity Done" />
                                        <asp:BoundField DataField="QuantityGPS" HeaderText="GPS Quantity Target" />
                                        <asp:BoundField DataField="QuantityGPSDone" HeaderText="GPS Quantity Done" />
                                        <asp:BoundField DataField="QuantityACS" HeaderText="ACS Quantity Target" />
                                        <asp:BoundField DataField="QuantityACSDone" HeaderText="ACS Quantity Done" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="blocked_cust.aspx.cs" Inherits="vtsadm.blocked_cust" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div id="box-jo" class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Job Blocked Information</h3>
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" id="txtBlockID" runat="server" class="form-control" placeholder="Please select ..." readonly="readonly" required="required" />
                                <span class="input-group-btn">
                                    <button id="Button5" runat="server" type="button" class="btn btn-block btn-primary btn-xs" data-toggle="modal" data-target="#modal-job_blocked"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
            ...
            <div class="col-md-6 col-xs-12">
                <div id="box-installation" class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Blocked Information</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtBlockedDate" TextMode="Date" runat="server" class="form-control" placeholder="Blocked Date ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Remark</label>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-job_blocked">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Job Blocked</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="blocked_cust_job_block_search.aspx" style="width: 100%; border: none; height: 350px; overflow: hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        ...
        function postJobBlockChild(sBlockID, sReqDate, sFullName, sSchDate, objCmd, sCustID, sCustBranchName) {
            if (sBlockID != '') {
                document.getElementById('ContentPlaceHolder1_txtBlockID').value = checkNbsp(sBlockID);

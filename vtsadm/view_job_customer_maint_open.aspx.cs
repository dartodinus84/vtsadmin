...
namespace vtsadm
{
    public partial class view_job_customer_maint_open : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_job_customer_maint_open '" + Session["SessionFilterType"].ToString() + "','" + Session["SessionSupportAreaName"].ToString() + "','" + Session["SessionDateFrom"].ToString() + "','" + Session["SessionDateTo"].ToString() + "'";

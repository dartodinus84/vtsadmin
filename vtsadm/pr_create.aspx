<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pr_create.aspx.cs" Inherits="vtsadm.pr_create" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtVendorAddress" runat="server" class="form-control" placeholder="Vendor Address ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Vendor Phone</label>
                            <asp:TextBox ID="txtVendorPhone" runat="server" class="form-control" placeholder="Vendor Phone ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Detail Purchase Request</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="PurID" HeaderText="PO ID" ItemStyle-Wrap="false" SortExpression="PurID"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="QuantityDone" HeaderText="Qty Delivery" ItemStyle-Wrap="false" SortExpression="QuantityDone"></asp:BoundField>
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>PO ID</label>
                            <asp:TextBox ID="txtPurID" runat="server" class="form-control" placeholder="Skip for new PUR header ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>PO Date</label>
                            <asp:TextBox ID="txtPurDate" TextMode="Date" runat="server" class="form-control" placeholder="PUR Date ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>PO Number</label>
                            <asp:TextBox ID="txtPurNumber" runat="server" class="form-control" placeholder="PUR Number ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>PO Type</label>
                            <asp:DropDownList ID="CmbPurType" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                        ...
                        <asp:HiddenField ID="txtContractTime" runat="server" Value="" />
                        <asp:HiddenField ID="txtTrialExpireDate" runat="server" Value="" />
                    </div>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowEditing="GridView1_RowEditing" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnSorting="GridView1_Sorting" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sPurDate" HeaderText="PO Date" ItemStyle-Wrap="false" SortExpression="sPurDate" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="VendorName" HeaderText="Vendor Name" ItemStyle-Wrap="false" SortExpression="VendorName" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="PurNumber" HeaderText="PO No" ItemStyle-Wrap="false" SortExpression="PurNumber" NullDisplayText="-"></asp:BoundField>
                                        <asp:BoundField DataField="PurTypeDesc" HeaderText="PO Type" ItemStyle-Wrap="false" SortExpression="PurTypeDesc" NullDisplayText="-"></asp:BoundField>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="CmdDelete" runat="server" Text="&lt;i class='fa fa-close'&gt;&lt;/i&gt;" ToolTip="Delete PR" CssClass="btn btn-danger btn-xs" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="VendorID" HeaderText="Vendor ID" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField DataField="PurTypeID" HeaderText="PO Type ID" ItemStyle-Wrap="false"></asp:BoundField>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to submit PO ID :&nbsp;</h6><label id="LblPurIDSubmit" runat="server"></label>&nbsp;?
                    </div>
        ...
        <div class="modal fade" id="modal-delete-header">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete PO ID :&nbsp;</h6><label id="LblPurID" runat="server"></label>&nbsp;?
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-customer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="pr_create_vendor_search.aspx" style="width: 100%; border: none; height: 350px;" overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal modal-open fade" id="modal-details" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframedetails" src="pr_create_details.aspx" style="width: 100%; border: none; height: 415px; overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    <script type="text/javascript">
        ...
        function postCustChild(sVendorID, sVendorName, sVendorAddress, sVendorPhone) {
            if (sVendorID != '') {
                ...
                document.getElementById('ContentPlaceHolder1_txtVendorAddress').value = sVendorAddress || '';
                document.getElementById('ContentPlaceHolder1_txtVendorPhone').value = sVendorPhone || '';
        ...
        function showDetails() {
            var purId;
            purId = document.getElementById('ContentPlaceHolder1_txtPurID');
            ...
            if (purId.value != '') {
                ...
                objPurID.value = purId.value;
                cmdClear.click();
                $('#modal-details').modal('show');
            }
            else {
                document.getElementById('ContentPlaceHolder1_div_comment').innerHTML = '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Failed!</strong> Please create purchase request header first!</div>';
        ...
        function confirmSubmit() {
            var objPurID = document.getElementById('ContentPlaceHolder1_txtPurID');
            if (objPurID.value != '') {
                document.getElementById('ContentPlaceHolder1_LblPurIDSubmit').innerHTML = objPurID.value;

﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mirroring_vehicle_customer_search.aspx.cs" Inherits="vtsadm.mirroring_vehicle_customer_search" %>
            ...
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FullName" HeaderText="Full Name" ItemStyle-Wrap="false"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="vts_company_id" HeaderText="VTS Company ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="intp_company_id" HeaderText="INTP Company ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="vts_company_nm" HeaderText="VTS Company Name" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="intp_company_nm" HeaderText="INTP Company Name" ItemStyle-Wrap="false"></asp:BoundField>

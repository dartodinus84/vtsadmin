...
namespace vtsadm
{
    public partial class rpt_job_maint_sbs : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptJobMaintSBFieldSort";
        string sViewStateDirSort = "RecRptJobMaintSBDirSort";
        string sSessionRecList = "RecRptJobMaintSB";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_job_maint_sbs '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "','" + CmbDeviceType.SelectedItem.Value.Trim() + "','" + CmbBranch.SelectedItem.Value.Trim() + "'";
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Job Order Details Maintenance Soft Blocked", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="document.aspx.cs" Inherits="vtsadm.document" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Docuement ID</label>
                            <asp:TextBox ID="txtDocID" runat="server" class="form-control" placeholder="Document ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Document Name</label>
                            <asp:TextBox ID="txtDocName" runat="server" class="form-control" placeholder="Document Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="DocID" HeaderText="Document ID" ItemStyle-Wrap="false" SortExpression="DocID"></asp:BoundField>
                                        <asp:BoundField DataField="DocName" HeaderText="Document Name" ItemStyle-Wrap="false" SortExpression="DocName"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Document ID :&nbsp;</h6>
                        <label id="LblDocID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtDocIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblDocID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtDocIDDelete').value = sText;

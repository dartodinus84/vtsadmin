...
namespace vtsadm
{
    public partial class rpt_job_maint_ub : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptJobMaintUBFieldSort";
        string sViewStateDirSort = "RecRptJobMaintUBDirSort";
        string sSessionRecList = "RecRptJobMaintUB";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_job_maint_ub_group_area '" + txtSearch.Text.Trim() + "','" + CmbGroupAreaID.SelectedItem.Value.ToString() + "', '" + CmbAreaID.SelectedItem.Value.ToString() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNURPTJOBMAINTUB"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Job Order Details Maintenance Unblocked", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

...
namespace vtsadm
{
    public partial class mst_igo_news_thumbnail : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                ...
                {
                    ImgInstall.ImageUrl = "~/Picture/igo/news/thumbnail/" + Session["ClsTypeNewsThumbnail"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 4) == "JPEG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "PNG")
                    {
                        ...
                        string strFullPathThumb = Server.MapPath("~/Picture/igo/news/thumbnail/") + strFileName;
                        ...
                        ImgInstall.ImageUrl = "~/Picture/igo/news/thumbnail/" + strFileName;
                        Session["ClsTypeNewsThumbnail"] = "https://vtsadmin.easygo-gps.co.id/picture/igo/news/thumbnail/" + strFileName;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mst_igo_delivery_bundle_gsm_details.aspx.cs" Inherits="vtsadm.mst_igo_delivery_bundle_gsm_details" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            function postDetails(sSockID, sGSM) {
                if (sSockID != '') {

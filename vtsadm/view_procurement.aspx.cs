...
namespace vtsadm
{
    public partial class view_procurement : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_procurement '" + txtSearch.Text.Trim() + "'";
        ...
        protected void CmdExportDone_Click(object sender, EventArgs e)
        {
            ...
            if (Rec.RecordCount() > 0)
            {
                if (clType.ExportToCsvTab(Rec, "Purchase Order Done", strFullPath.Trim(), 50000, ref sMsg))
                {
                    Response.Clear();
                    Response.ContentType = "text/plain";
                    Response.AddHeader("content-disposition", "attachment;filename=\"" + strFileName + "\"");

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="job_deal.aspx.cs" Inherits="vtsadm.job_deal" EnableEventValidation="false" %>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Import Deal</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-inline">
                            <asp:FileUpload ID="fuImportExcel" runat="server" CssClass="form-control" accept=".xlsx" />
                            <asp:Button ID="CmdImportExcel" runat="server" CssClass="btn btn-primary" Text="Import Excel"
                                CausesValidation="false" UseSubmitBehavior="true" formnovalidate="formnovalidate"
                                OnClick="CmdImportExcel_Click" />
                            <a class="btn btn-default" href="/Export/Template_Import_Customer_Deal.xlsx" download="Template_Import_Customer_Deal.xlsx">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Deal</h3>
                        <div class="box-tools">
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-customer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="job_deal_customer_search.aspx" style="width: 100%; border: none; height: 350px;" overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">

...
namespace vtsadm
{
    public partial class view_job_maint_close : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_job_maint_close '" + Session["SessionFilterType"].ToString() + "','" + Session["SessionGroupAreaName"].ToString() + "','" + Session["SessionDateFrom"].ToString() + "','" + Session["SessionDateTo"].ToString() + "'";

...
namespace vtsadm
{
    public partial class dashboard_assign_bytechnician_detail : System.Web.UI.Page
    {
        ...
        protected void Open_GridView(string type, string from, string to, string areaid, string picareaid)
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_assign_bytechnician_detail '" + type + "', '" + areaid + "','" + picareaid + "','" + from + "','" + to + "'";

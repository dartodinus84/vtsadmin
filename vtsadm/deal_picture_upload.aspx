<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deal_picture_upload.aspx.cs" Inherits="vtsadm.deal_picture_upload" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="box box-solid" style="background-color: #f7f7f7;">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <button id="CmdRemove" runat="server" type="button" class="btn btn-primary" onserverclick="CmdRemove_ServerClick">Remove All</button>
                ...
                <div class="box box-solid" style="background-color: #f7f7f7;">
                    <div class="box-body">
                        <div id="divpic" class="form-group form-group-sm" style="height:195px;text-align:center;">   
                            ...
                            <div class="mt-3">
                                <asp:Label ID="lblImageCount" runat="server" CssClass="badge badge-info"></asp:Label>
                            </div>

                            <asp:Image ID="ImgInstall" runat="server" BorderWidth="0px" height="100%"/>

                            <asp:Panel ID="pnlImages" runat="server" CssClass="mt-4">
        ...
        <script type="text/javascript">
            ...
            function removeImage(index) {
                // Call the server-side method to remove the image
                PageMethods.RemoveImageByIndex(index, onRemoveSuccess, onRemoveError);
            }

            function onRemoveSuccess() {
                // Reload the page to refresh the image gallery
                window.location.reload();
            }

            function onRemoveError(error) {
                alert("Error removing image: " + error.get_message());
            }

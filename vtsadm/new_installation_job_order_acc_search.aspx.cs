...
namespace vtsadm
{
    public partial class new_installation_job_order_acc_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_new_installation_job_order_acc_search '" + sName + "'";
            Session["RecListNewInstallationJobOrderAccSearch"] = ClType.Open_GridView(GridView1, strSQL, Session["ClsTypeDBConnStringSQL"].ToString(), LblPaging);
        }
        protected void GridView1_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListNewInstallationJobOrderAccSearch"], LblPaging);
        }
        ...
        protected void GridView1_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "parent.postJobOrderAccChild('" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "'," +
                                              ...
                                              "'" + e.Row.Cells[30].Text.ToString() + "'); return false;";
                    for (int i = 7; i <= 30; i++)
                    {
                        e.Row.Cells[i].Visible = false;
                    }

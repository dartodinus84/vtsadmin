...
namespace vtsadm
{
    public partial class gsm_maint_suspend_gsm_search : System.Web.UI.Page
    {
        ...
        protected void CmdSearchGsm_Click(object sender, EventArgs e)
        {
            try
            {
                Open_GridViewGsm(txtSearchGsm.Value.Trim());
            }
            catch (Exception ex)
            {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_gsm_maint_suspend_gsm_search '" + txtCustID.Value.Trim() + "','" + txtJobID.Value.Trim() + "','" + sSearch + "'";
            Session["RecListGsmMaintGsmSearch"] = ClType.Open_GridView(GridView1, strSQL, Session["ClsTypeDBConnStringSQL"].ToString(), LblPaging);
        }
        protected void GridView1_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListGsmMaintGsmSearch"], LblPaging);
        }
        ...
        protected void GridView1_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "parent.postGsmChild('" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "','" + e.Row.Cells[2].Text.ToString() + "'," +

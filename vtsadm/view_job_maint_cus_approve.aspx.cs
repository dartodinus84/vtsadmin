...
namespace vtsadm
{
    public partial class view_job_maint_cus_approve : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewJOCusApproveFieldSort";
        string sViewStateDirSort = "RecViewJOCusApproveDirSort";
        string sSessionRecList = "RecViewJOCusApprove";
        protected void Open_GridView()
        {
            try
            {
                ClsType ClType = new ClsType();
                string strSQL = "sp_list_view_job_maint_cus_approve'" + txtSearch.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUJOCSAPPROVE"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewJOCusApprove"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Job Maint Customer - Approve", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();
        ...
        protected void CmdYesApprove_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtJoIDApprove.Value.Trim() != "")
                {
                    ...
                    {
                        strSQL1 = "sp_insert_sp_maint_auto_approve '" + txtTvdIDApprove.Value.Trim() + "','" + txtJoIDApprove.Value.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";
                        if (ec.Execute(strSQL1, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff1, ref sErr1))
                        {
                            if (intAff1 > 0)
                            {
                                ...
                                sendEmailApprove(txtJoIDApprove.Value.Trim(), txtTvdIDApprove.Value.Trim(), txtSeqIDApprove.Value.Trim());
                                clear();
                                Open_GridView();
        ...
        protected void CmdYesDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtJoIDDelete.Value.Trim() != "")
                {
                    ...
                    {
                        strSQL1 = "sp_job_order_maint_detail_sp_reject '" + txtJoIDDelete.Value.Trim() + "','" + txtTvdIDDelete.Value.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";
                        if (ec.Execute(strSQL1, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff1, ref sErr1))
                        {
                            if (intAff1 > 0)
                            {
                                ...
                                sendEmailReject(txtJoIDApprove.Value.Trim(), txtTvdIDApprove.Value.Trim(), txtSeqIDApprove.Value.Trim());
                                clear();
                                Open_GridView();
        ...
        private void sendEmailApprove(string sJobID, string sTvdID, string sSeq)
        {
            try
            {
                var pageData = new view_job_maint_cus_approve();

...
namespace vtsadm
{
    public partial class job_postdeal_customer_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            //string strSQL = "sp_list_job_postdeal_customer_search '" + sFullName + "'";
            string strSQL;
                    ...
                    !string.IsNullOrEmpty(Session["ClsTypeUserMarketingID"].ToString()))
            {
                ...
                strSQL = "sp_list_job_postdeal_customer_search '" + sFullName + "','" + userID + "'";
            }
            else
            {
                // User non-marketing: pakai parameter search saja (tanpa filter marketing)
                strSQL = "sp_list_job_postdeal_customer_search '" + sFullName + "'";
            }

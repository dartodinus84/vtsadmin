...
namespace vtsadm
{
    public partial class vehicle_maint : System.Web.UI.Page
    {
        static ITelegramBotClient botClient;

        public vehicle_maint()
        {
        ...
        private void clear()
        {
            try
            {
                ...
                txtNewVehicleID.Value = "";
                txtNewVehicleDesc.Value = "";
                txtNewPoliceNo.Value = "";
                txtNewAssetNo.Value = "";
                txtNewTvaID.Value = "";

                txtNewCustBranchName.Value = "";
                txtNewCustomerID.Value = "";
                txtNewCustomerName.Value = "";
                ...
                txtNewRemark.Text = "";
                txtTelegram.Text = "";
                Session["ClsTypeVehicleMaintPicture"] = "";
        ...
        protected void CmdClear_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                clear();
                Open_GridViews(GridView2, "sp_list_vehicle_maint_upline", txtTvaID.Value.ToString(), "RecListVehicleMaintUpline", LblPagingUpline);
                Open_GridViews(GridView3, "sp_list_vehicle_maint_master", txtTvaID.Value.ToString(), "RecListVehicleMaintMaster", LblPagingMaster);
                Open_GridViewAcc(GridView4, "sp_list_vehicle_maint_accessories_selected", txtTvdID.Value.ToString(), txtTechnicianID.Value.ToString(), "RecListVehicleMaintAccessoriesSelected", LblPagingS);
                Open_GridViews(GridView1, "sp_list_new_vehicle_maint_upline", txtNewTvaID.Value.ToString(), "RecListNewVehicleMaintUpline", LblPagingNewUpline);
                Open_GridViews(GridView5, "sp_list_new_vehicle_maint_master", txtNewTvaID.Value.ToString(), "RecListNewVehicleMaintMaster", LblPagingNewMaster);
                Open_GridViewTelegram();
                div_comment.InnerHtml = "";
            }
            catch (Exception ex)
        ...
        protected void CmdLoadData_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Open_GridViews(GridView3, "sp_list_vehicle_maint_master", txtTvaID.Value.ToString(), "RecListVehicleMaintMaster", LblPagingMaster);
                Open_GridViewAcc(GridView4, "sp_list_vehicle_maint_accessories_selected", txtTvdID.Value.ToString(), txtTechnicianID.Value.ToString(), "RecListVehicleMaintAccessoriesSelected", LblPagingS);
                Session["VehicleMaintCustID"] = txtCustomerID.Value.Trim();
                div_comment.InnerHtml = "";
            }
            catch (Exception ex)
            {
        ...
        protected void CmdYesSubmit_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (txtJobID.Value.Trim() != "" && txtVehicleID.Value.Trim() != "" && txtDeviceID.Value.Trim() != "" && txtNewVehicleID.Value.Trim() != "")
                    {
                        if (CmbStatusOldVehicle.SelectedItem.Value.Trim() != "[Select]")
                        {
                            strSQL = "sp_insert_vehicle_maint '" + txtTvdID.Value.Trim() + "','" + txtTvaID.Value.Trim() + "','" + txtNewTvaID.Value.Trim() + "'," +
                             "'" + txtVehicleID.Value.Trim() + "','" + txtNewVehicleID.Value.Trim() + "','" + txtTdtID.Value.Trim() + "'," +
                             "'" + txtTgtID.Value.Trim() + "','" + txtTechnicianID.Value.Trim() + "','" + Session["ClsTypeUserTechnicianID"].ToString() + "','" + txtJobID.Value.Trim() + "'," +
                             "'" + txtDate.Value.Trim() + "','" + CmbStatusOldVehicle.SelectedItem.Value.Trim() + "','" + txtNewRemark.Text.ToString() + "'," +
                             "'" + Session["ClsTypeVehicleMaintPicture"].ToString() + "','" + Session["ClsTypeUserID"].ToString() + "'";
                            if (ec.Execute(strSQL, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff, ref sErr))
                            {
                                if (intAff > 0)
                                {
                                    saveTelegram();
                                    string sTVDID = getTvdID(txtNewTvaID.Value.ToString(), txtTdtID.Value.ToString(), txtTgtID.Value.ToString(), Session["ClsTypeUserTechnicianID"].ToString());
                                    checkJO(txtJobID.Value.Trim(), sTVDID, txtTelegram.Text.Trim(), txtVehicleID.Value.Trim(), txtPoliceNo.Value.Trim(), CmbStatusOldVehicle.SelectedItem.Value.Trim());
                                    Open_GridViews(GridView2, "sp_list_vehicle_maint_upline", txtTvaID.Value.ToString(), "RecListVehicleMaintUpline", LblPagingUpline);
                                    Open_GridViews(GridView3, "sp_list_vehicle_maint_master", txtTvaID.Value.ToString(), "RecListVehicleMaintMaster", LblPagingMaster);
                                    Open_GridViewAcc(GridView4, "sp_list_vehicle_maint_accessories_selected", txtTvdID.Value.ToString(), txtTechnicianID.Value.ToString(), "RecListVehicleMaintAccessoriesSelected", LblPagingS);
                                    clear();
                                    //txtTvdID.Text = getTvdID(txtTvaID.Text.ToString(), txtTdtID.Text.ToString(), txtTgtID.Text.ToString(), txtTechnicianID.Value.Trim());
                            ...
                            {
                                string sErrRollback = "";
                                strSQL = "sp_insert_vehicle_maint_rollback '" + txtTvdID.Value.Trim() + "'";
                                ec.Execute(strSQL, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff, ref sErrRollback);
                                div_comment.InnerHtml = "<div class='alert alert-danger alert-dismissible'><h4><i class='icon fa fa-ban'></i> Failed!</h4>Saving vehicle maintenance has been failed (" + sErr + ")</div>";
                            }
                        }
                        else
                        {
            ...
            {
                div_comment.InnerHtml = "<div class='alert alert-danger alert-dismissible'><h4><i class='icon fa fa-ban'></i> Failed!</h4>Saving vehicle maintenance has been failed (" + ex.Message + ")</div>";
            }
        }
        protected void GridView4_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListVehicleMaintAccessoriesSelected"], LblPagingS);
            div_comment.InnerHtml = "";
        }
        protected void GridView2_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListVehicleMaintUpline"], LblPagingUpline);
            div_comment.InnerHtml = "";
        }
        protected void GridView3_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListVehicleMaintMaster"], LblPagingMaster);
            div_comment.InnerHtml = "";
        }
        protected void GridView1_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListNewVehicleMaintUpline"], LblPagingNewUpline);
            div_comment.InnerHtml = "";
        }
        protected void GridView5_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListNewVehicleMaintMaster"], LblPagingNewMaster);
            div_comment.InnerHtml = "";
        }
        ...
        private void checkJO(string sJobID, string sTvdid, string sTelegram, string sVehicleID, string sOldPoliceNo, string sStatusVehicle)
        {
            try
            {
                var pageData = new vehicle_maint();
                Recordset Rec = new Recordset();
                string strSQL = "sp_get_maint_vehicle_status '" + sJobID + "','CL','" + sTvdid + "'";
                ...
                if (Rec.RecordCount() > 0)
                {
                    ...
                    while (!Rec.EOF)
                    {
                        ...
                        notifTelegramVehicle(sMaintTypeDesc, sJoID, sCustomerName, sRemark, sSchDate, sPoliceNo, sMSIDN, sGSM, sOldPoliceNo, sTelegram, sBranch);
                        Rec.MoveNext();
                    }
                }
            }
        ...
        protected void notifTelegramVehicle(string sMaintTypeDesc, string sJoID, string sCustomerName, string sRemark, string sSchDate, string sPoliceNo, string sMSIDN, string sGSM, string sOldPoliceNo, string sTelegram, string sBranch)
        {
            try
            {
                string sChatID = "";
                ...
                string text = BodyTelegramVehicle(sMaintTypeDesc, sJoID, sCustomerName, sRemark, sSchDate, sPoliceNo, sMSIDN, sGSM, sOldPoliceNo, sTelegram, sBranch);
        ...
        private string BodyTelegramVehicle(string sMaintTypeDesc, string sJoID, string sCustomerName, string sRemark, string sSchDate, string sPoliceNo, string sMSIDN, string sGSM, string sOldPoliceNo, string sTelegram, string sBranch)
        {
            string msg = "";

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="customer_maint.aspx.cs" Inherits="vtsadm.customer_maint" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Customer ID</label>
                            <div class="input-group input-group-sm">
                                <input type="text" id="txtNewCustID" runat="server" class="form-control" placeholder="Please select ..." readonly="readonly" />
                                <span class="input-group-btn">
                                    <button id="Button1" runat="server" type="button" class="btn btn-block btn-primary btn-xs" data-toggle="modal" data-target="#modal-customernew"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Customer Name</label>
                            <input type="text" id="txtNewCustName" runat="server" class="form-control" placeholder="Customer Name ..." readonly="readonly" />
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Branch Name</label>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-job_order">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="customer_maint_job_order_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-vehicle">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframevehicle" src="customer_maint_vehicle_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-customernew">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframenewcustomer" src="customer_maint_new_customer_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        ...
        function postNewCustomerChild(sNewCustID, sNewCustName, sNewCustBranchName) {
            if (sNewCustID != '') {
                document.getElementById('ContentPlaceHolder1_txtNewCustID').value = checkNbsp(sNewCustID);
                document.getElementById('ContentPlaceHolder1_txtNewCustName').value = checkNbsp(sNewCustName);
                document.getElementById('ContentPlaceHolder1_txtNewCustBranchName').value = checkNbsp(sNewCustBranchName);

                $('#modal-customernew').modal('hide');
        ...
        function endRequest(sender, args) {
            ...
            var $modalMsg = $('#modal-messagebox');
            if (typeof $modalSubmit.modal === 'function') {
                $modalSubmit.modal('hide');
            } else {
                $modalSubmit.removeClass('in').css('display', 'none');
                $('.modal-backdrop').remove();
                document.body.classList.remove('modal-open');
            }
            $('#iload').hide();
            $('#modal-submit .btn-confirmasi').prop('disabled', false);
            $('#modal-submit button.close').show();
            $modalMsg.off('hidden.bs.modal').on('hidden.bs.modal', function () {
                document.body.style.paddingRight = '0px';
            });
            var divComment = document.getElementById('ContentPlaceHolder1_div_comment');
            var isExists = divComment ? divComment.innerHTML : '';
            if (isExists != '') {
                if (typeof $modalMsg.modal === 'function') {
                    $modalMsg.modal('show');
                } else {
                    $modalMsg.addClass('in').css('display', 'block');
                    $modalMsg.after('<div class="modal-backdrop fade in"></div>');
                }
            }
        }
        endRequest();

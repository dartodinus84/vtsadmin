<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="gsm_mutation_technician_tech.aspx.cs" Inherits="vtsadm.gsm_mutation_technician_tech" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Gsm - Technician Mutation       
                <small>Input</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li><a href="#">Gsm</a></li>
            <li class="active">Gsm Technician Mutation</li>
        </ol>
    </section>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <span class="input-group-btn">
                                    <button id="Button2" runat="server" type="button" class="btn btn-block btn-primary btn-xs"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
            ...
            <div class="col-md-6">
                ...
                <div id="div_mutation" runat="server" class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            <label>Old Tgt ID</label>
                            <asp:TextBox ID="txtOldTgtID" runat="server" class="form-control" placeholder="Old Tgt ID ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="box box-solid">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Gsm - Technician Mutation</h3>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"
                        <div class="form-group form-group-sm" style="overflow: hidden;">
                            <iframe src="gsm_mutation_upload.aspx" style="width: 100%; border: none; height: 370px; overflow: hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Tgt ID :&nbsp;</h6>
                        <label id="LblTgtID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtTgtIDDelete" runat="server" />
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-gsm">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="gsm_mutation_technician_gsm_search.aspx" style="width: 100%; border: none; height: 350px; overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-techniciannew">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframetechniciannew" src="gsm_mutation_technician_new_technician_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-upload">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="gsm_mutation_technician_upload.aspx" style="width: 100%; border: none; height: 430px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sTgtID, sTgwID, sGsmID, sWarehouseID, sTechnicianID, sStatus) {
            if (sTgtID != '') {
                document.getElementById('ContentPlaceHolder1_LblTgtID').innerHTML = sTgtID;
                document.getElementById('ContentPlaceHolder1_txtTgtIDDelete').value = sTgtID;

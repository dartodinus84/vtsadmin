...
namespace vtsadm
{
    public partial class rpt_dashboard_customer : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_customer__listCustomer '" + "','" + ddServer.SelectedItem.Value.Trim() + "'";
        ...
        private void clear()
        {
            try
            {
                ...
                ClType.Open_Combos(ddPackage, Session["ClsTypeDBConnStringSQL"].ToString(), "", "sp_dashboard_customer__list_package");
                //CmbWarehouse.SelectedValue = "[Select]";
            }
            catch (Exception ex)
            {

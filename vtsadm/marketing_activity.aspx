<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="marketing_activity.aspx.cs" Inherits="vtsadm.marketing_activity" EnableEventValidation="false" %>
    ...
    <section class="content">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtPICName" runat="server" class="form-control" placeholder="Branch Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>PIC Phone</label>
                            <asp:TextBox ID="txtPICPhone" runat="server" class="form-control" placeholder="Branch Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtTrainingID" runat="server" class="form-control" placeholder="Skip for new training ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Training Order</h3>
                        <div class="box-tools">
        ...
        <div class="modal fade" id="modal-delete-header">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Training ID :&nbsp;</h6><label id="LblTrainingID" runat="server"></label>&nbsp;?
                        <input type="hidden" id="txtTrainingIDDelete" runat="server" />
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-customer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="job_training_customer_search.aspx" style="width: 100%; border: none; height: 350px;" overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                ...
                document.getElementById('ContentPlaceHolder1_txtTrainingIDDelete').value = sText;

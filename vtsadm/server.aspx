<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="server.aspx.cs" Inherits="vtsadm.server" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtServerID" runat="server" class="form-control" placeholder="Skip for new customer ..." disabled="" ></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Server Name</label>
                            <asp:TextBox ID="txtServerName" runat="server" class="form-control" placeholder="Server Name ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Description</label>
                            <asp:TextBox ID="txtDescr" runat="server" class="form-control" placeholder="Description ..."></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Server</h3>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Descr" HeaderText="Description" ItemStyle-Wrap="false" SortExpression="Descr"></asp:BoundField>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label id="LblServerID" runat="server"></label>
                        &nbsp;?
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblServerID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtServerIDDelete').value = sText;

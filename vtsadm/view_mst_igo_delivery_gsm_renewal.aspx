<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_mst_igo_delivery_gsm_renewal.aspx.cs" Inherits="vtsadm.view_mst_igo_delivery_gsm_renewal" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Delivery GSM Renewal           
                <small>View</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li><a href="#">View</a></li>
            <li class="active">Delivery GSM Renewal</li>
        </ol>
    </section>

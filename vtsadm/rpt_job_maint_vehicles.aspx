<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_job_maint_vehicles.aspx.cs" Inherits="vtsadm.rpt_job_maint_vehicles" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order - Maintenance - Vehicle 
                <small>Report</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="InstallDate" HeaderText="Date Install" ItemStyle-Wrap="false" SortExpression="InstallDate"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="PoliceNo_Old" HeaderText="Car Plate Old" ItemStyle-Wrap="false" SortExpression="PoliceNo_Old"></asp:BoundField>

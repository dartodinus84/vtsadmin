<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mst_igo_selling_delivery_bundle_search.aspx.cs" Inherits="vtsadm.mst_igo_selling_delivery_bundle_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                ...
                <input type="text" id="txtSearchOrderID" runat="server" class="form-control" placeholder="Search By GPS SN..." />
            ...
            <asp:Panel runat="server" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="gps_sn" HeaderText="GPS Number" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="gsm_no" HeaderText="GSM Number" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="gps_model" HeaderText="Device Type" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="seller_cust_name" HeaderText="Device Type" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="seller_cust_email" HeaderText="Device Type" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="seller_cust_address" HeaderText="Device Type" ItemStyle-Wrap="false"></asp:BoundField>

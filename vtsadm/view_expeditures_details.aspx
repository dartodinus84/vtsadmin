<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_expeditures_details.aspx.cs" Inherits="vtsadm.view_expeditures_details" %>
        ...
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:BoundField DataField="ProcurementID" HeaderText="Expeditures ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="QtyGsmFinal" HeaderText="Qty Gsm Final" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="QtyDeviceFinal" HeaderText="Qty Device Final" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Qty12VFinal" HeaderText="Qty 12 Volt Final" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Qty24VFinal" HeaderText="Qty 12 Volt Final" ItemStyle-Wrap="false"></asp:BoundField>

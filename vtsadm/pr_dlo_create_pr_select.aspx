<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pr_dlo_create_pr_select.aspx.cs" Inherits="vtsadm.pr_dlo_create_pr_select" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="text" id="txtSearchPr" runat="server" class="form-control" placeholder="Search by PR / Vendor ..." />
                <span class="input-group-btn">
                    <button id="CmdSearchPr" runat="server" type="button" class="btn btn-block btn-primary btn-xs" onserverclick="CmdSearchPr_Click"><i class="fa fa-search"></i></button>
                </span>
            </div>
        </div>
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="PurID" HeaderText="Pur ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="PurNumber" HeaderText="PR Number" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="sPurDate" HeaderText="PR Date" ItemStyle-Wrap="false"></asp:BoundField>

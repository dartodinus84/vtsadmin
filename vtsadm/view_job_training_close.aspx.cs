...
namespace vtsadm
{
    public partial class view_job_training_close : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_job_training_close '" + Session["SessionFilterType"].ToString() + "','" + Session["SessionDateFrom"].ToString() + "','" + Session["SessionDateTo"].ToString() + "'";
            ...
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "postDetails('" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "'," +
                                              ...
                                              "'" + e.Row.Cells[20].Text.ToString() + "','" + e.Row.Cells[21].Text.ToString() + "','" + e.Row.Cells[22].Text.ToString() + "','" + e.Row.Cells[23].Text.ToString() + "'); return false;";
                    LinkButton CmdFunc = (LinkButton)e.Row.FindControl("CmdFunc");
                    CmdFunc.OnClientClick = "postFunc('" + e.Row.Cells[16].Text.ToString() + "'); return false;";

                    LinkButton CmdPic = (LinkButton)e.Row.FindControl("CmdPic");
                    CmdPic.OnClientClick = "postPic('" + e.Row.Cells[23].Text.ToString() + "'); return false;";

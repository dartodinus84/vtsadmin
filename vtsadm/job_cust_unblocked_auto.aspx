<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="job_cust_unblocked_auto.aspx.cs" Inherits="vtsadm.job_cust_unblocked_auto" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order 
            <small>Customer Unblocked</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="#">Job Order</a></li>
            <li class="active">Customer Unblocked</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Unblock Information</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Unblock ID</label>
                            <asp:TextBox ID="txtUnblockID" runat="server" class="form-control" placeholder="Skip for new unblock ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Customer Unblocked Order</h3>
                        <div class="box-tools">
        ...
        <div class="modal fade" id="modal-delete-header">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete unblock ID :&nbsp;</h6><label id="LblUnblockID" runat="server"></label>&nbsp;?
                        <input type="hidden" id="txtUnblockIDDelete" runat="server" />
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-customer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="job_cust_unblocked_customer_search.aspx" style="width: 100%; border: none; height: 350px;" overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblUnblockID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtUnblockIDDelete').value = sText;

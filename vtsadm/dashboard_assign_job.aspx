<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="dashboard_assign_job.aspx.cs" Inherits="vtsadm.dashboard_assign_job" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Dashboard <small>Assignment Job</small></h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li class="active">Assignment Job</li>
        </ol>
    </section>
    ...
    <section class="content assign-dashboard">
        <div class="assign-topbar">
            ...
            <div class="assign-tabs">
                <button type="button" class="assign-tab-btn active" data-tab="teknisi">Teknisi</button>
                <button type="button" class="assign-tab-btn" data-tab="itsupport" onclick="window.location.href='dashboard_assign_job_itsupport.aspx';">IT Support</button>
            </div>
        ...
        <asp:HiddenField ID="hfActiveTab" runat="server" Value="teknisi" />
            ...
            <div class="summary-card card-total">
                    ...
                    <div class="summary-column-grid">
                        <div class="summary-column">
                            <p class="summary-column-title">New Installation</p>
                        ...
                        <div class="summary-column">
                            <p class="summary-column-title">Maintenance</p>
        ...
        <div class="section-box" runat="server" visible="false">
            <div class="section-header">
                <h4 class="section-title">Data Performance Bulan Ini - <span id="lblActiveTabTitle" runat="server">Teknisi</span></h4>
        ...
        <div class="section-box">
            <div class="section-header">
                <h4 class="section-title">Jadwal Harian <span id="lblScheduleTabTitle" runat="server">Teknisi</span></h4>
                <span id="lblMemberCount" runat="server" class="panel-badge">0 Person</span>
                <div class="area-filter-wrap">
                    ...
                    <div class="area-filter-bar">
                        <asp:Repeater ID="rptRegionalTabs" runat="server" OnItemCommand="rptRegionalTabs_ItemCommand">
                            <ItemTemplate>
                                <asp:LinkButton
                                    ID="lnkRegionalTab"
                                    runat="server"
        ...
        <div class="section-box perf-chart-section">
            <div class="section-header">
                <h4 class="section-title">Grafik Kinerja <span id="lblPerfChartTabTitle">Teknisi</span></h4>
                <div class="perf-chart-controls">
                    <select id="assignPerfTechSelect" class="perf-chart-select" aria-label="Pilih teknisi">
                        <option value="">Memuat teknisi...</option>
                    </select>
                </div>
            </div>
            <div class="perf-chart-note-wrap">
                <p class="perf-chart-note" id="assignPerfChartNote">Grafik kinerja per teknisi mengikuti periode dan filter regional dashboard. IsMaint=0 (New Install) dan IsMaint=1 (Maintenance) dijumlahkan.</p>
            </div>
            <div class="perf-chart-grid">
                <div class="perf-chart-panel">
                    ...
                    <div id="assignPerfDailyChart" class="perf-chart-canvas" role="img" aria-label="Grafik kinerja harian teknisi"></div>
                </div>
                <div class="perf-chart-panel">
                    ...
                    <div id="assignPerfMonthlyChart" class="perf-chart-canvas" role="img" aria-label="Grafik kinerja bulanan teknisi"></div>
                </div>
            </div>
        </div>
        ...
        <div class="assign-job-modal" role="dialog" aria-modal="true" aria-labelledby="assignJobTitle">
            <div class="assign-job-modal-header">
                <div class="assign-job-title-wrap">
                    <h4 id="assignJobTitle">Assign Teknisi</h4>
                    <p id="assignJobSubtitle">Pilih job order dan status teknisi</p>
                </div>
            ...
            <div class="assign-job-body">
                <div class="assign-info-grid">
                    <div class="assign-info-item">
                        <span class="assign-info-label">Teknisi</span>
                ...
                <div id="assignJobSectionWrap">
                    ...
                    <div class="assign-jo-type" id="assignJobTypeWrap">
                        <button type="button" class="assign-jo-type-btn active" data-jo-type="installation">JO New Install</button>
                        <button type="button" class="assign-jo-type-btn" data-jo-type="maintenance">JO Maintenance</button>
                    </div>
                    ...
                    <div class="assign-order-card">
                        ...
                        <div class="assign-info-item">
                            <span class="assign-info-label">Sisa GPS</span>
                            <span class="assign-info-value" id="assignInfoRemainingGps">0</span>
                        </div>
                        <div class="assign-info-item">
                            <span class="assign-info-label">Sisa ACS</span>
                    ...
                    <div class="assign-field">
                        ...
                        <input type="number" id="assignInputUnit" min="1" value="1" placeholder="Input assign GPS unit" />
                        <small class="assign-field-hint" id="assignInputUnitHint">Sisa GPS : 0</small>
                    </div>
                    <div class="assign-field">
    ...
    <div class="assign-job-backdrop" id="assignStatusBackdrop">
        <div class="assign-job-modal" role="dialog" aria-modal="true" aria-labelledby="assignStatusTitle">
            <div class="assign-job-modal-header">
                <div class="assign-job-title-wrap">
                    <h4 id="assignStatusTitle">Ubah Status Teknisi</h4>
                    <p id="assignStatusSubtitle">Pilih status terbaru teknisi</p>
                </div>
        ...
        <div class="assign-jo-info-modal" role="dialog" aria-modal="true" aria-labelledby="assignJoInfoTitle">
            ...
            <div class="assign-job-body">
                <div class="assign-jo-search-wrap">
                    <input type="text" id="assignJoSearchInput" placeholder="Search Job Order..." />
                    ...
                    <table class="assign-jo-table">
                        <thead>
                            <tr>
                                ...
                                <th>Customer</th>
                                <th>Branch Name</th>
                                <th class="assign-jo-device-type-col">Device Type</th>
                                <th>Sisa GPS</th>
                                <th>Sisa ACS</th>
                                <th>Last Assign / Day</th>
                                <th>Action</th>
                            </tr>
                        </thead>
        ...
        <div class="assign-report-modal" role="dialog" aria-modal="true" aria-labelledby="assignReportTitle">
            <div class="assign-report-header">
                ...
                <div class="assign-report-title-wrap">
                    ...
                    <p id="assignReportSubtitle">Detail pekerjaan selesai teknisi</p>
                </div>
            ...
            <div class="assign-report-body">
                ...
                <div class="assign-report-assign-card" id="assignReportAssignCard">
                    ...
                    <div class="assign-field">
                        ...
                        <small class="assign-field-hint" id="assignReportInputUnitHint">Sisa GPS : 0</small>
                    </div>
                    <div class="assign-field">
    ...
    <div class="assign-tech-modal-backdrop" id="assignTechStockBackdrop">
    ...
    <div class="assign-tech-detail-backdrop" id="assignTechDeviceDetailBackdrop">
        <div class="assign-tech-detail-modal" role="dialog" aria-modal="true" aria-labelledby="assignTechDeviceDetailTitle">
            <div class="assign-tech-detail-head">
                <div>
                    <h4 id="assignTechDeviceDetailTitle">Detail Device Teknisi</h4>
            ...
            <div class="assign-tech-detail-footer">
                <div class="assign-tech-detail-legend">
                    ...
                    <div class="assign-tech-detail-legend-item">
                        ...
                        <span>= Alat Cabutan (Belum QC, Serahkan ke Admin Teknisi)</span>
                    </div>
                    <div class="assign-tech-detail-legend-item">
        ...
        (function () {
            ...
            function syncAssignAreaDropdown() {
                ...
                if (!areaLookupState.rows.length) {
                    ...
                    areaSelect.disabled = true;
                    setAreaHint(areaHint, "Area tidak tersedia untuk regional ini.", "error");
                    return;
                }
            ...
            function renderScheduleReportTableRows() {
                ...
                for (var i = 0; i < rows.length; i++) {
                    ...
                    var statusText = row.StatusText || (isCompleted ? "Selesai" : "Belum Selesai");
                    ...
                    if (!isCompleted && isScheduleRowNewInstall(row)) {
                        ...
                        if (installUrl) {
                            installButton = "<a class=\"assign-report-install-btn\" href=\"" + escapeHtml(installUrl) + "\" title=\"Input New Installation\">New Install</a>";
                        }
                    }
                    var deleteButton = canDelete
                        ? "<button type=\"button\" class=\"assign-report-delete-btn\" data-row-index=\"" + i + "\">Delete</button>"
                        : "";
                    var actionButton = "<div class=\"assign-report-action-wrap\">" + detailButton + installButton + deleteButton + "</div>";
                    html.push("<tr>"
            ...
            function syncReportAssignInputHint(remainingUnit) {
                ...
                var safeRemaining = Math.max(0, toInt(remainingUnit, 0));
                var groupText = reportModalState.deviceGroupId === "ACS" ? "ACS" : "GPS";
                if (inputLabel) {
                    inputLabel.textContent = "Assign " + groupText + " Unit";
                }
                if (inputUnit) {
                    inputUnit.placeholder = "Input assign " + groupText + " unit";
                    inputUnit.max = safeRemaining.toString();
                }
                if (inputHint) {
                    inputHint.textContent = "Sisa " + groupText + " : " + safeRemaining.toString();
                }
            }
            ...
            function renderReportAssignForm() {
                ...
                if (pickedJo) {
                    pickedJo.textContent = selected
                        ? (selected.JobID + " - " + getCustomerDisplayText(selected) + " (" + (selected.BranchName || "-") + ")")
                ...
                if (remainGps) {
                    remainGps.textContent = remainingGps.toString();
                }
                if (remainAcs) {
                    remainAcs.textContent = remainingAcs.toString();
                }
                ...
                if (input) {
                    if (!input.value || toInt(input.value, 0) < 1) {
                        input.value = "1";
                    }
                    if (toInt(input.value, 0) > selectedRemaining) {
                        input.value = selectedRemaining.toString();
                    }
                }
                ...
                if (assignBtn) {
                    var bothZero = remainingGps <= 0 && remainingAcs <= 0;
                    ...
                    assignBtn.textContent = isAssignLoading ? "Saving..." : "Assign";
                }
            ...
            function validateReportAssignInput(showFeedback) {
                ...
                if (remaining <= 0) {
                    if (showFeedback) {
                        setReportFeedback("Sisa " + groupText + " sudah habis.", true, false);
                    }
                    return false;
                }
                if (qty <= 0) {
                    if (showFeedback) {
                        setReportFeedback("Input unit assign minimal 1.", true, false);
                    }
                    return false;
                }
                if (qty > remaining) {
                    ...
                    if (showFeedback) {
                        setReportFeedback("Assign " + groupText + " melebihi sisa " + groupText, true, false);
                    }
                    return false;
                }
                return true;
                    ...
                    function (result) {
                        ...
                        if (!isSuccess) {
                            if (showFeedbackOnError) {
                                setReportFeedback((result && result.Message) || "Gagal memuat laporan schedule.", true, false);
                            }
            ...
            function openCompletedReportModal(cell) {
                ...
                if (subtitle) {
                    subtitle.textContent = "Ringkasan JO selesai pada teknisi terpilih";
                }
            ...
            function submitAssignFromReportModal(actionSource) {
                ...
                if (getIsTechnicianUser()) {
                    setReportFeedback("User teknisi hanya dapat melihat detail informasi.", true, false);
                    return;
                }
                ...
                if (!reportModalState.technicianId || !reportModalState.schDate) {
                    setReportFeedback("Teknisi atau tanggal schedule tidak valid.", true, false);
                    return;
                }
                ...
                if (isAvailableStatus) {
                    ...
                    qty = toInt(document.getElementById("assignReportInputUnit") ? document.getElementById("assignReportInputUnit").value : "0", 0);
            ...
            function deleteAssignFromReportRow(rowIndex) {
                if (getIsTechnicianUser()) {
                    setReportFeedback("User teknisi tidak memiliki akses untuk menghapus assignment.", true, false);
                    return;
                }
            ...
            function openTotalJobModal(trigger) {
                ...
                if (count) {
                    count.textContent = totalJob.toString();
                }
                if (totalUnitCount) {
                ...
                callAssignPageMethod(
                    ...
                    function (result) {
                        ...
                        if (count) {
                            count.textContent = toInt(result && result.TotalClosedJO, totalJob).toString();
                        }
                        if (totalUnitCount) {
                            totalUnitCount.textContent = toInt(result && result.TotalClosedUnit, 0).toString();
                        }
            ...
            function renderStockLoadingSkeleton(message) {
                return "<div class=\"assign-stock-loading\">" + escapeHtml(message || "Memuat stok teknisi...") + "</div>";
            }
            ...
            function openTechDeviceDetailModal(params) {
                var technicianId = params && params.technicianId ? params.technicianId : "";
                var technicianName = params && params.technicianName ? params.technicianName : "";
                var deviceTypeId = params && params.deviceTypeId ? params.deviceTypeId : "";
                var deviceTypeDesc = params && params.deviceTypeDesc ? params.deviceTypeDesc : "";
                if (!technicianId || !deviceTypeId) {
                    return;
                }

                var title = document.getElementById("assignTechDeviceDetailTitle");
                var subtitle = document.getElementById("assignTechDeviceDetailSubtitle");
                var body = document.getElementById("assignTechDeviceDetailTableBody");
                if (title) {
                    title.textContent = "Detail Device Teknisi";
                }
                if (subtitle) {
                    subtitle.textContent = (technicianName || "-") + " - " + (deviceTypeDesc || "-");
                }
                if (body) {
                    body.innerHTML = "<tr><td colspan=\"4\">" + renderStockLoadingSkeleton("Memuat detail device...") + "</td></tr>";
                }

                techDeviceDetailState.technicianId = technicianId;
                techDeviceDetailState.technicianName = technicianName;
                techDeviceDetailState.deviceTypeId = deviceTypeId;
                techDeviceDetailState.deviceTypeDesc = deviceTypeDesc;
                techDeviceDetailState.rows = [];
                techDeviceDetailState.searchText = "";
                setTechDeviceDetailFeedback("", false);
                ...
                var cacheKey = technicianId + "|" + deviceTypeId;
                if (techDeviceDetailCache.hasOwnProperty(cacheKey)) {
                    techDeviceDetailState.rows = techDeviceDetailCache[cacheKey] || [];
                    renderTechDeviceDetailRows();
                    return;
                }

                callAssignPageMethod(
                    "LoadTechnicianGpsDetail",
                    {
                    ...
                    function (result) {
                        var status = (result && result.Result ? result.Result : "").toUpperCase();
                        if (status !== "SUCCESS") {
                            setTechDeviceDetailFeedback((result && result.Message) || "Gagal memuat detail device teknisi.", true);
                            renderTechDeviceDetailRows();
                            return;
                        }

                        techDeviceDetailState.rows = result && result.Rows ? result.Rows : [];
                        techDeviceDetailCache[cacheKey] = techDeviceDetailState.rows.slice(0);
                        renderTechDeviceDetailRows();
                    },
                    function (errorMessage) {
                        setTechDeviceDetailFeedback(errorMessage || "Gagal memuat detail device teknisi.", true);
                        renderTechDeviceDetailRows();
                    });
            }
            ...
            function openTechStockModal(trigger) {
                var techName = trigger ? (trigger.getAttribute("data-tech-name") || "-") : "-";
                var techId = trigger ? (trigger.getAttribute("data-tech-id") || "") : "";
                var title = document.getElementById("assignTechStockTitle");
                var content = document.getElementById("assignTechStockContent");
                if (title) {
                    title.textContent = techName;
                }
                if (content) {
                    content.innerHTML = renderStockLoadingSkeleton("Memuat stok teknisi...");
                }
                ...
                if (!techId) {
                    if (content) {
                        content.innerHTML = "<div class=\"assign-jo-empty\">TechnicianID tidak ditemukan.</div>";
                    }
                    return;
                }

                techStockState.technicianId = techId;
                techStockState.technicianName = techName;
                ...
                callAssignPageMethod(
                    ...
                    function (result) {
                        ...
                        if (status !== "SUCCESS") {
                            if (content) {
                                content.innerHTML = "<div class=\"assign-jo-empty\">" + escapeHtml((result && result.Message) ? result.Message : "Gagal memuat stock teknisi.") + "</div>";
                            }
                            return;
                        }

                        if (content) {
                            techStockState.gpsDevices = result && result.GpsDevices ? result.GpsDevices : [];
                            techStockState.gsmItems = result && result.GsmItems ? result.GsmItems : [];
                            techStockState.accessories = result && result.Accessories ? result.Accessories : [];
                            techStockState.totalUnit = toInt(result && result.TotalUnit, 0);
                            content.innerHTML = renderTechStockModalContent(result || {});
                        }
                    },
                    function (errorMessage) {
                        if (content) {
                            content.innerHTML = "<div class=\"assign-jo-empty\">" + escapeHtml(errorMessage || "Gagal memuat stock teknisi.") + "</div>";
                        }
                    });
            }
            ...
            function handleTechSummaryAction(event) {
                ...
                if (stockTrigger) {
                    ...
                    openTechStockModal(stockTrigger);
                }
            }
            ...
            function openStatusOnlyModal(cell) {
                ...
                if (subtitle) {
                    subtitle.textContent = "TechnicianID: " + technicianId;
                }
            ...
            function getAssignPageUrl() {
                var path = window.location.pathname || "dashboard_assign_job.aspx";
                return path.substring(path.lastIndexOf("/") + 1) || "dashboard_assign_job.aspx";
            }
            ...
            function getJoInfoTableColspan() {
                return normalizeJoTypeForApi(assignModalState.joType) === "installation" ? 8 : 7;
            }
            ...
            function renderOrderInfo() {
                ...
                if (remainingGps) {
                    remainingGps.textContent = toInt(selected.RemainingUnitGps, 0).toString();
                }
                if (remainingAcs) {
                    remainingAcs.textContent = toInt(selected.RemainingUnitAcs, 0).toString();
                }
                if (inputUnit) {
                    inputUnit.max = selectedGroupRemaining.toString();
                    if (!inputUnit.value || parseInt(inputUnit.value, 10) < 1) {
                        inputUnit.value = "1";
                    }
                    if (parseInt(inputUnit.value, 10) > selectedGroupRemaining) {
                        inputUnit.value = selectedGroupRemaining.toString();
                    }
                }
                syncAssignInputByDeviceGroup(selectedGroupRemaining);
                renderSelectedJoText();
                if (areaSelect && normalizeAreaId(areaSelect.value) !== normalizeAreaId(assignModalState.selectedAreaId)) {
                    areaSelect.value = normalizeAreaId(assignModalState.selectedAreaId);
                }
            ...
            function syncAssignInputByDeviceGroup(remainingUnit) {
                var inputUnit = document.getElementById("assignInputUnit");
            ...
            function validateAssignUnitInput(showFeedback) {
                ...
                var qtyInput = document.getElementById("assignInputUnit");
                ...
                if (remainingUnit <= 0) {
                    qtyInput.value = "0";
                    if (showFeedback) {
                        setFeedback("Sisa " + groupText + " sudah habis.", true, false);
                    }
                    return false;
                }
                ...
                if (!qtyValue || qtyValue < 1) {
                    if (showFeedback) {
                        setFeedback("Input unit assign minimal 1.", true, false);
                    }
                    return false;
                }

                if (qtyValue > remainingUnit) {
                    qtyInput.value = remainingUnit.toString();
                    if (showFeedback) {
                        setFeedback("Assign " + groupText + " melebihi sisa " + groupText, true, false);
                    }
                    return false;
                }
            ...
            function openAssignModal(cell) {
                ...
                if (subtitle) {
                    subtitle.textContent = "TechnicianID: " + (cell.getAttribute("data-tech-id") || "-");
                }
            ...
            function bindAssignModalControls() {
                ...
                if (statusOnlySubmitBtn) {
                    statusOnlySubmitBtn.addEventListener("click", function () {
                        ...
                        if (!technicianId) {
                            setStatusOnlyFeedback("Teknisi tidak valid.", true, false);
                            return;
                        }
                        if (!scheduleDate) {
                ...
                if (submitBtn) {
                    submitBtn.addEventListener("click", function () {
                        ...
                        if (!technicianId) {
                            setFeedback("Teknisi tidak valid.", true, false);
                            return;
                        }
                        if (!scheduleDate) {
                        ...
                        if (isAvailableStatus) {
                            ...
                            qty = qtyInput ? parseInt(qtyInput.value, 10) : 0;
                            fallbackDisplay = qty.toString();
                        }
            ...
            function applyAssignPerfChartResult(chartResult, rawResult, technician, periodeParts) {
                ...
                setPerfChartNote("Data grafik mengikuti periode " + periodeParts.value + " dan filter regional dashboard. Gunakan panah untuk melihat minggu sebelumnya/berikutnya.");
            }
            ...
            function handlePerfTechSelectChange() {
                ...
                if (!technician.id) {
                    renderEmptyAssignPerfCharts("Pilih teknisi terlebih dahulu.", "-", periodeParts.year, periodeParts.month);
                    return;
                }
            ...
            function loadPerfTechniciansFromApi(callback) {
                callAssignPageMethod(
                    ...
                    function (errorMessage) {
                        ...
                        if (typeof callback === "function") {
                            callback([], { Message: errorMessage || "Gagal memuat teknisi." });
                        }
                    });
            }
            ...
            function renderAssignPerfCharts() {
                ...
                loadPerfTechniciansFromApi(function (technicians, listResult) {
                    ...
                    if (!selectedTechId) {
                        assignPerfChartState.isLoading = false;
                        renderEmptyAssignPerfCharts((listResult && listResult.Message) || "Belum ada teknisi pada filter ini.", "-", periodeParts.year, periodeParts.month);
                        return;
                    }

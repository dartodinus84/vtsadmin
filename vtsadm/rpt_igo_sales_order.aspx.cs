...
namespace vtsadm
{
    public partial class rpt_igo_sales_order : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptMstSOFieldSort";
        string sViewStateDirSort = "RecRptMstSODirSort";
        string sSessionRecList = "RecRptMstSO";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_igo_master_order '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";

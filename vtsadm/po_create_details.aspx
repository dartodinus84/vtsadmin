<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="po_create_details.aspx.cs" Inherits="vtsadm.po_create_details" %>
    ...
    <form id="form1" runat="server">
        <div class="box-body">
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <input type="text" id="txtTotalStockDevice" runat="server" class="form-control" placeholder="0" readonly="readonly" />
                    </div>
                    <div class="col-xs-6">
                        <input type="text" id="txtMinimumStockDevice" runat="server" class="form-control" placeholder="0" readonly="readonly" />
                    </div>
                </div>
            </div>
            <div class="form-group form-group-sm">

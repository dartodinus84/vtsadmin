...
namespace vtsadm
{
    public partial class others_maint_upload : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                if (Session["ClsTypeOthersMaintPicture"].ToString() != "")
                {
                    ImgInstall.ImageUrl = "~/Picture/" + Session["ClsTypeOthersMaintPicture"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
        ...
        protected void CmdUpload_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG")
                    {
                        ...
                        Session["ClsTypeOthersMaintPicture"] = strFileName;

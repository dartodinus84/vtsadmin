...
namespace vtsadm
{
    public partial class view_avaliable_technician : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_technician_assign_detail_avaliable '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "TechnicianID";
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Avaliable Technician", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

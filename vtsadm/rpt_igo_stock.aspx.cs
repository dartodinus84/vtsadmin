...
namespace vtsadm
{
    public partial class rpt_igo_stock : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptMstStckFieldSort";
        string sViewStateDirSort = "RecRptMstStckDirSort";
        string sSessionRecList = "RecRptMstStck";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_igo_master_stock '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";

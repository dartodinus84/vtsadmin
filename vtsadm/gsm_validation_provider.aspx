<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gsm_validation_provider.aspx.cs" Inherits="vtsadm.gsm_validation_provider" %>
                ...
                <div class="box box-solid" style="background-color: #f7f7f7;">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <button id="CmdUpload" runat="server" type="button" class="btn btn-primary" onclick="showOverlay();" onserverclick="CmdUpload_ServerClick">Upload</button>
                            <button id="CmdCancel" runat="server" type="button" class="btn btn-primary" onserverclick="CmdCancel_ServerClick">Cancel</button>
                             
                            <asp:Button ID="CmdExportCSV" CssClass="btn btn-primary" runat="server" OnClick="CmdExport_Click" Text="Export CSV" />
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="GsmID" HeaderText="Gsm ID" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="MSIDN" HeaderText="MSIDN" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="ProviderID" HeaderText="Provider ID" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="DateArrival" HeaderText="Date Arrival" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="SourceID" HeaderText="Source ID" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="BatchNo" HeaderText="Batch No" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="Gsm_Status" HeaderText="Status" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="ICCID" HeaderText="ICCID" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" ItemStyle-Wrap="false" />

                                        <asp:BoundField DataField="MarketingName" HeaderText="Marketing Name" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="DeviceTypeDesc" HeaderText="Device Type" ItemStyle-Wrap="false" />

                                        <asp:BoundField DataField="MaintTypeDesc" HeaderText="Maintenance Type" ItemStyle-Wrap="false" />
                                        <asp:BoundField DataField="GsmType" HeaderText="Gsm Type" ItemStyle-Wrap="false" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vehicle_maint_new_vehicle_search.aspx.cs" Inherits="vtsadm.vehicle_maint_new_vehicle_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="hidden" id="txtCustID" runat="server" value="" />

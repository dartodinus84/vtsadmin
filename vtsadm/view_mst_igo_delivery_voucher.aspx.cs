...
namespace vtsadm
{
    public partial class view_mst_igo_delivery_voucher : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewVoucherFieldSort";
        string sViewStateDirSort = "RecViewVoucherDirSort";
        string sSessionRecList = "RecViewVoucher";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_igo_master_delivery_voucher '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewVoucher"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Voucher", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

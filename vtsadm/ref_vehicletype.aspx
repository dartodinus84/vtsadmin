<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ref_vehicletype.aspx.cs" Inherits="vtsadm.ref_vehicletype" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Type Vehicle</li>
        </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Type Vehicle Information</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Vehicle ID</label>
                            <asp:TextBox ID="txtVehicleTypeID" runat="server" class="form-control" placeholder="Skip for new Type Vehicle ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Vehicle Brand</label>
                             <asp:DropDownList ID="CmbVehicleBrandID" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Type Vehicle</h3>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Type Vehicle ID :&nbsp;</h6>
                        <label id="LblVehicleTypeID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtVehicleTypeIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblVehicleTypeID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtVehicleTypeIDDelete').value = sText;

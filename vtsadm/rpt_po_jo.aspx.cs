...
namespace vtsadm
{
    public partial class rpt_po_jo : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_po_jo '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "','" + CmbDeviceType.SelectedItem.Value.Trim() + "','" + CmbBranch.SelectedItem.Value.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNURPTPOJOBSUM"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Sales Order -  New Installation", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

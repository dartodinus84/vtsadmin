...
namespace vtsadm
{
    public partial class mst_igo_selling_delivery_bundle_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_igo_delivery_stock_search '" + txtOrderID.Value.Trim() + "','" + sName + "'";
        ...
        protected void GridView1_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "parent.postStockChild('" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "'," +
                                      "'" + e.Row.Cells[2].Text.ToString() + "','" + e.Row.Cells[3].Text.ToString() + "','" + e.Row.Cells[4].Text.ToString() + "','" + e.Row.Cells[5].Text.ToString() + "','" + e.Row.Cells[6].Text.ToString() + "');return false;";
        ...
        protected void CmdSearchJobOrder_ServerClick(object sender, EventArgs e)
        {
            try
            {
                Open_GridViewJobOrder(txtSearchOrderID.Value.Trim());
            }
            catch (Exception ex)
            {

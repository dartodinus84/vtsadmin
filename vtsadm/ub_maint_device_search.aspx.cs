...
namespace vtsadm
{
    public partial class ub_maint_device_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_ub_maint_device_search '" + txtCustID.Value.Trim() + "','" + txtJobID.Value.Trim() + "','" + sSearch + "'";
            Session["RecListUBMaintDeviceSearch"] = ClType.Open_GridView(GridView1, strSQL, Session["ClsTypeDBConnStringSQL"].ToString(), LblPaging);
        }
        protected void GridView1_PageIndexChanging(Object sender, System.Web.UI.WebControls.GridViewPageEventArgs e)
        {
            ClsType ClType = new ClsType();
            ClType.Gv_PageIndexChanging((sender as GridView), e.NewPageIndex, Session["RecListUBMaintDeviceSearch"], LblPaging);
        }

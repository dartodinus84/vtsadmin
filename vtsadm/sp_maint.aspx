<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sp_maint.aspx.cs" Inherits="vtsadm.sp_maint" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-4 col-xs-12">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Date</label>
                            <input type="date" id="txtDate" runat="server" class="form-control" placeholder="Date ..." readonly="readonly" />
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Remark</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm" style="overflow: hidden;">
                            <iframe src="sp_maint_upload.aspx" style="width: 100%; border: none; height: 370px; overflow: hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-job_order">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="sp_maint_job_order_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-device">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframedevice" src="sp_maint_device_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        (function () {
            ...
            if (!prm._spMaintEndRequestBound) {
                prm.add_endRequest(spMaintEndRequest);
                prm._spMaintEndRequestBound = true;
            }
        })();
        ...
        function checkNbsp(sBuff) {
            ...
            var sOut = sBuff.toString();
            if (sOut === '&nbsp;') {
                return '';
            }
            sOut = sOut.replace(/&#160;/gi, ' ').replace(/\u00A0/g, ' ');
            return sOut.trim();
        }
        ...
        function spMaintEndRequest(sender, args) {
            $('#iload').hide();
            ...
            if (args && args.get_error && args.get_error()) {
                ...
                alert('Page update failed. Please refresh and try again.');
                return;
            }
            ...
            var isExists = (divComment.innerHTML || '').replace(/&nbsp;/gi, '').replace(/\s/g, '');
            if (isExists && typeof $.fn.modal === 'function') {

...
namespace vtsadm
{
    public partial class view_mst_igo_selling : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewSoldFieldSort";
        string sViewStateDirSort = "RecViewSoldDirSort";
        string sSessionRecList = "RecViewSold";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "usp_retail_gsm_not_yet_active '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "sell_date";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWIGOSOLD"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewSold"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Sold - Voucher and GSM Not Active", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

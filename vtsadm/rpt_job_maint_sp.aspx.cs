...
namespace vtsadm
{
    public partial class rpt_job_maint_sp : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptJobMaintSPFieldSort";
        string sViewStateDirSort = "RecRptJobMaintSPDirSort";
        string sSessionRecList = "RecRptJobMaintSP";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_job_maint_sp_group_area '" + txtSearch.Text.Trim() + "','" + CmbGroupAreaID.SelectedItem.Value.ToString() + "', '" + CmbAreaID.SelectedItem.Value.ToString() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNURPTJOBMAINTSP"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Job Order Details Maintenance Suspended", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

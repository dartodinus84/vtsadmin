...
namespace vtsadm
{
    public partial class rpt_igo_delivery : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptMstDlvFieldSort";
        string sViewStateDirSort = "RecRptMstDlvDirSort";
        string sSessionRecList = "RecRptMstDlv";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_igo_master_order_delivery '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "order_id";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUIGORPTSTK"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Report iGO Tracker - Stock Of Name", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

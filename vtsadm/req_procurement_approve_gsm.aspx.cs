...
namespace vtsadm
{
    public partial class req_procurement_approve_gsm : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_header_procurement_approve_gsm '" + txtSearch.Text.Trim() + "'";
        ...
        protected void CmdCreate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtProcurementID.Value.Trim() != "")
                {
                    ...
                    if (txtProcurementDesc.Value == "New")
                    {

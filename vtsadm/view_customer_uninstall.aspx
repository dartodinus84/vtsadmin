<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_customer_uninstall.aspx.cs" Inherits="vtsadm.view_customer_uninstall" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                ...
                <input type="text" id="txtSearch" runat="server" class="form-control" placeholder="Search by any fields ..."/>
        ...
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:BoundField DataField="InstallDate" HeaderText="Date" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="PoliceNo" HeaderText="Police Number" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Brand" HeaderText="Brand" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Model" HeaderText="Model" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Type" HeaderText="Type" ItemStyle-Wrap="false"></asp:BoundField>
                      ...
                      --%>  <asp:BoundField DataField="NoSN" HeaderText="IMEI" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="MSIDN" HeaderText="No GSM" ItemStyle-Wrap="false"></asp:BoundField>
                    </Columns>

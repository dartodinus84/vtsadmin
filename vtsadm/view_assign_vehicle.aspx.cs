...
namespace vtsadm
{
    public partial class view_assign_vehicle : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewAssignVehicleFieldSort";
        string sViewStateDirSort = "RecViewAssignVehicleDirSort";
        string sSessionRecList = "RecViewAssignVehicle";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_assignment_vehicle '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "PoliceNo";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWASSIGNVEH"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewAssignVehicle"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, "Assignment Vehicle", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();
            ...
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "postDetails('" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "'," +
                                              ...
                                              "'" + e.Row.Cells[20].Text.ToString() + "'); return false;";
                    ...
                    LinkButton CmdUpline = (LinkButton)e.Row.FindControl("CmdUpline");
                    CmdUpline.OnClientClick = "postUpline('" + e.Row.Cells[12].Text.ToString() + "','" + e.Row.Cells[0].Text.ToString() + "'); return false;";

                    LinkButton CmdMaster = (LinkButton)e.Row.FindControl("CmdMaster");
                    CmdMaster.OnClientClick = "postMaster('" + e.Row.Cells[12].Text.ToString() + "','" + e.Row.Cells[0].Text.ToString() + "'); return false;";

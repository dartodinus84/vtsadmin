...
namespace vtsadm
{
    public partial class fms_menu_v2 : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_fms_menu_v2 '" + txtSearch.Text.Trim() + "'";
        ...
        private void clear()
        {
            try
            {
                ...
                ClType.Open_Combos(CmbParentID, Session["ClsTypeDBConnStringSQL"].ToString(), "", "sp_list_fms_parent_v2");
        ...
        protected void GridView2_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            try
            {
                ...
                string rawDesc = (e.CommandSource as GridView).Rows[iRow].Cells[10].Text.Trim();
                sMenuDesc = (rawDesc == "&nbsp;" ? "" : rawDesc);
            ...
            try
            {
                ...
                else
                {
                    if (txtMenuID.Text.Trim() != "")
                    {
                        if (CmbIsParent.SelectedItem.Value.Trim() != "[Select]")
                        {
                            strSQL = "sp_update_fms_menu_v2 '" + txtMenuID.Text.Trim() + "','" + txtMenuName.Text.Trim() + "','" + TextMenuDesc.Text.Trim() + "','" + txtMenuUrl.Text.Trim() + "','" + Session["ClsTypeMenuTMSImage"] + "','" + Session["ClsTypeMenuTMSThumbnail"] + "','" + txtMenuIcon.Text.Trim() + "','" + CmbIsParent.SelectedItem.Value.Trim() + "','" + CmbParentID.SelectedItem.Value.Trim() + "','" + txtMenuPos.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";
        ...
        protected void CmdYesDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtMenuIDDelete.Value.Trim() != "")
                {
                    ...
                    {
                        strSQL = "sp_delete_fms_menu_v2 '" + txtMenuIDDelete.Value.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdPic.OnClientClick = "postPic('" + e.Row.Cells[15].Text.ToString() + "'); return false;";

                    LinkButton CmdPic2 = (LinkButton)e.Row.FindControl("CmdPic2");
                    CmdPic2.OnClientClick = "postPic2('" + e.Row.Cells[16].Text.ToString() + "'); return false;";

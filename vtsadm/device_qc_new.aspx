<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="device_qc_new.aspx.cs" Inherits="vtsadm.device_qc_new" EnableEventValidation="false" %>

<%@ Register Assembly="System.Web.Extensions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31BF3856AD364E35" Namespace="System.Web.UI" TagPrefix="asp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Device Quality Control - New Device       
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">QC New Device</li>
        </ol>
    </section>
                        ...
                        <asp:UpdatePanel ID="UpdatePanelPending" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="GPS_Time" HeaderText="GPS Time" 
                                        ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center" 
                                        DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" 
                                        NullDisplayText="N/A" />
                                    
                                    <asp:TemplateField HeaderText="Process" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Button ID="btnProcess" runat="server" 
                                                Text="Process" 
                                                CssClass="btn btn-primary btn-sm" 
                                                CommandName="Process" 
                                                CommandArgument='<%# Eval("NoSN") %>'
    ...
    <script type="text/javascript">
        ...
        function addTag() {
            ...
            if (inputValue === '') {
                showBarcodeFeedback('warning', '⚠ Please scan or enter a Device ID');
                return;
            }
        ...
        function removeTag(tagElement) {
            var deviceID = tagElement.getAttribute('data-device-id');
            tagElement.remove();
            updateTagsCounter();
            updateHiddenField();
            showBarcodeFeedback('info', '🗑️ Removed: ' + deviceID);
            focusScanInput();
        }
        ...
        function updateHiddenField() {
            ...
            for (var i = 0; i < tags.length; i++) {
                deviceIDs.push(tags[i].getAttribute('data-device-id'));
            }
            
            var hdnField = document.getElementById('<%= hdnScannedDevices.ClientID %>');
            if (hdnField) {
                hdnField.value = deviceIDs.join(',');
            }
        }
        ...
        function validateAndSearchMultiple() {
            ...
            if (count === 0) {
                alert('⚠ No devices scanned!\n\nPlease scan at least one device barcode before searching.');
                focusScanInput();
                return false;
            }

...
namespace vtsadm
{
    public partial class mst_igo_sales_order_details : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_igo_master_stock_search '" + txtSearch.Text.Trim() + "'";
        ...
        protected void CmdSaveDetail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSQL = "usp_retail_selling_bundle '" + sOrderID + "','" + sInv + "','" + sName + "','" + sAdd + "','" + sEmail + "','" + txtStockID.Value.Trim() + "','" + txtSN.Text.Trim() + "','" + txtGSM.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";

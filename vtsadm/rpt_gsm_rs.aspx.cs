...
namespace vtsadm
{
    public partial class rpt_gsm_rs : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_gsm_rs '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNURPTGSMRS"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (Rec.RecordCount() > 0)
                //{
                //    if (clType.ExportToCsvTab(Rec, "GSM - Ready to Suspend", strFullPath.Trim(), 50000, ref sMsg))
                //    {
                //        Response.Clear();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_job_news.aspx.cs" Inherits="vtsadm.rpt_job_news" EnableEventValidation="false" %>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="dtmupd_install" HeaderText="Date Install" ItemStyle-Wrap="false" SortExpression="dtmupd_install"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Remark_Job_Header" HeaderText="Remark" ItemStyle-Wrap="false" SortExpression="Remark_Job_Header"></asp:BoundField>
                                        <asp:BoundField DataField="DeviceTypeDesc" HeaderText="Device" ItemStyle-Wrap="false" SortExpression="DeviceTypeDesc"></asp:BoundField>
                                        <asp:BoundField DataField="ServerName" HeaderText="Server" ItemStyle-Wrap="false" SortExpression="ServerName"></asp:BoundField>
                                        <asp:BoundField DataField="PPN" HeaderText="PPN" ItemStyle-Wrap="false" SortExpression="PPN"></asp:BoundField>
                                    </Columns>

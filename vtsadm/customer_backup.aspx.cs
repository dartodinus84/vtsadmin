...
namespace vtsadm
{
    public partial class customer_backup : System.Web.UI.Page
    {
        ...
        private bool checkUserPass(ref string sErr)
        {
            ...
            try
            {
                if (txtUserID.Text.Trim() != "" && txtUserName.Text.Trim() != "" && txtPassword.Text.Trim() != "")
                {
                    BoolOK = true;
                }
                else
                {
                    sErr = "Userid, Username and password should be filled";
                }
            }
            catch (Exception ex)
            {
                        ...
                        if (checkUserPass(ref sErr))
                        {
                            strSQL = "sp_insert_customer '" + CmbBranchID.SelectedItem.Value.Trim() + "','" + CmbCustTypeID.SelectedItem.Value.ToString() + "'," +
                                     ...
                                     "'" + txtCustGroupID.Value.Trim() + "','" + CmbMarketing.SelectedItem.Value.Trim() + "','" + txtUserID.Text.Trim() + "'," +
                                             "'" + txtUserName.Text.Trim() + "','" + txtPassword.Text.Trim() + "','" + txtBusinessFields.Value.Trim() + "','" + txtOperationalArea.Value.Trim() + "','" + txtVehicleType.Value.Trim() + "','" + CmbServiceTypeID.SelectedItem.Value.ToString() + "','" + Session["ClsTypeUserID"].ToString() + "'";
                ...
                else
                {
                    ...
                    if (ec.Execute(strSQL, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff, ref sErr))
                    {
                        if (intAff > 0)
                        {
                            ...
                            {
                                div_comment.InnerHtml = "<div class='alert alert-danger' role='alert'><button type = 'button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><strong>Failed!</strong> Interfacing update customer has been failed (" + sErr + ")</div>";
                            }
                        }
                        else
                        {
        ...
        protected void CmdUpdateUser_ServerClick(object sender, EventArgs e)
        {
            try
            {
                string testing = Session["ClsTypeUserID"].ToString();
                ...
                if (txtCustomerID.Text.Trim() != "")
                {
                    if (txtUserID.Text.Trim() != "")
                    {
                        if (txtUserName.Text.Trim() != "")
                        {
                            ...
                            {
                                strSQL = "sp_update_interfacing_user_customer '" + txtCustomerID.Text.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "','" + txtUserID.Text.Trim() + "'," +
                                "'" + txtUserName.Text.Trim() + "','" + txtPassword.Text.Trim() + "','" + txtNewUserID.Text.Trim() + "'";
                                if (ec.Execute(strSQL, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff, ref sErr))
                                {
                                    if (intAff > 0)
                                    {
        ...
        protected void GridView2_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            try
            {
                ...
                string sAttachName = ""; string sAttachDesc = ""; string sAttachUrl = ""; string sPeriodStart = ""; string sPeriodEnd = ""; string sServiceTypeID = ""; string sITS = "";
                ...
                sBillingAddr = (e.CommandSource as GridView).Rows[iRow].Cells[13].Text.Trim();
                sTaxAddress = (e.CommandSource as GridView).Rows[iRow].Cells[14].Text.Trim();
                sShipmentAddress = (e.CommandSource as GridView).Rows[iRow].Cells[15].Text.Trim();
                sPICName1 = (e.CommandSource as GridView).Rows[iRow].Cells[16].Text.Trim();
                sPICPosition1 = (e.CommandSource as GridView).Rows[iRow].Cells[17].Text.Trim();
                sPICName2 = (e.CommandSource as GridView).Rows[iRow].Cells[18].Text.Trim();
                sPICPosition2 = (e.CommandSource as GridView).Rows[iRow].Cells[19].Text.Trim();
                sPICName3 = (e.CommandSource as GridView).Rows[iRow].Cells[20].Text.Trim();
                sPICPosition3 = (e.CommandSource as GridView).Rows[iRow].Cells[21].Text.Trim();
                sPICName4 = (e.CommandSource as GridView).Rows[iRow].Cells[22].Text.Trim();
                sPICPosition4 = (e.CommandSource as GridView).Rows[iRow].Cells[23].Text.Trim();
                sOfficePhone1 = (e.CommandSource as GridView).Rows[iRow].Cells[24].Text.Trim();
                sOfficePhone2 = (e.CommandSource as GridView).Rows[iRow].Cells[25].Text.Trim();
                sOfficePhone3 = (e.CommandSource as GridView).Rows[iRow].Cells[26].Text.Trim();
                sOfficePhone4 = (e.CommandSource as GridView).Rows[iRow].Cells[27].Text.Trim();
                sMobilePhone1 = (e.CommandSource as GridView).Rows[iRow].Cells[28].Text.Trim();
                sMobilePhone2 = (e.CommandSource as GridView).Rows[iRow].Cells[29].Text.Trim();
                sMobilePhone3 = (e.CommandSource as GridView).Rows[iRow].Cells[30].Text.Trim();
                sMobilePhone4 = (e.CommandSource as GridView).Rows[iRow].Cells[31].Text.Trim();
                sEmail1 = (e.CommandSource as GridView).Rows[iRow].Cells[32].Text.Trim();
                sEmail2 = (e.CommandSource as GridView).Rows[iRow].Cells[33].Text.Trim();
                sEmail3 = (e.CommandSource as GridView).Rows[iRow].Cells[34].Text.Trim();
                sEmail4 = (e.CommandSource as GridView).Rows[iRow].Cells[35].Text.Trim();
                sMarketingID = (e.CommandSource as GridView).Rows[iRow].Cells[36].Text.Trim();
                sCustGroupID = (e.CommandSource as GridView).Rows[iRow].Cells[37].Text.Trim();
                sUserID_Server = (e.CommandSource as GridView).Rows[iRow].Cells[38].Text.Trim();
                sUserName_Server = (e.CommandSource as GridView).Rows[iRow].Cells[39].Text.Trim();
                sPass_Server = (e.CommandSource as GridView).Rows[iRow].Cells[40].Text.Trim();
                sBusiness = (e.CommandSource as GridView).Rows[iRow].Cells[41].Text.Trim();
                sOperational = (e.CommandSource as GridView).Rows[iRow].Cells[42].Text.Trim();
                sVehicleType = (e.CommandSource as GridView).Rows[iRow].Cells[43].Text.Trim();

                sAttachName = (e.CommandSource as GridView).Rows[iRow].Cells[44].Text.Trim();
                sAttachDesc = (e.CommandSource as GridView).Rows[iRow].Cells[45].Text.Trim();
                sAttachUrl = (e.CommandSource as GridView).Rows[iRow].Cells[46].Text.Trim();
                sPeriodStart = (e.CommandSource as GridView).Rows[iRow].Cells[47].Text.Trim();
                sPeriodEnd = (e.CommandSource as GridView).Rows[iRow].Cells[48].Text.Trim();
                sServiceTypeID = (e.CommandSource as GridView).Rows[iRow].Cells[49].Text.Trim();
                sITS = (e.CommandSource as GridView).Rows[iRow].Cells[49].Text.Trim();
                ...
                switch (e.CommandName.ToUpper())
                {
                    case "CHANGES":
                        if (sStatus.ToUpper().Trim() != "DE")
                        {
                            ...
                            CmbMarketing.SelectedValue = ClType.CheckNbsp(sMarketingID);
                            txtUserID.Text = ClType.CheckNbsp(sUserID_Server);
                            txtUserName.Text = ClType.CheckNbsp(sUserName_Server);
                            txtPassword.Text = ClType.CheckNbsp(sPass_Server);

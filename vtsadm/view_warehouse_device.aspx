<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_warehouse_device.aspx.cs" Inherits="vtsadm.view_warehouse_device" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="hidden" id="txtWarehouseID" runat="server" />

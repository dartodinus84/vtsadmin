...
namespace vtsadm
{
    public partial class fms_menu_image_v2 : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                if (Session["ClsTypeMenuTMSImage"].ToString() != "")
                {
                    ImgInstall.ImageUrl = "~/Picture/tms/menu/" + Session["ClsTypeMenuTMSImage"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 4) == "JPEG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "PNG")
                    {
                        ...
                        Session["ClsTypeMenuTMSImage"] = "https://vtsadmin.easygo-gps.co.id/picture/tms/menu/" + strFileName;
                        ...
                        //Session["ClsTypeMenuTMSImage"] = strFileName;
                        //lblMsg.InnerHtml = "<strong>Success!</strong>";

...
namespace vtsadm
{
    public partial class view_job_create_open : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_job_create_open '" + Session["SessionFilterType"].ToString() + "','" + Session["SessionGroupAreaName"].ToString() + "','" + Session["SessionDateFrom"].ToString() + "','" + Session["SessionDateTo"].ToString() + "'";
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    // Total columns
                    e.Row.Cells[9].CssClass = "total-col"; // Total Quantity
                    e.Row.Cells[10].CssClass = "total-col"; // Total Quantity Done

                    // GPS columns
                    e.Row.Cells[11].CssClass = "gps-col"; // GPS Quantity Target
                    e.Row.Cells[12].CssClass = "gps-col"; // GPS Quantity Done

                    // ACS columns
                    e.Row.Cells[13].CssClass = "acs-col"; // ACS Quantity Target
                    e.Row.Cells[14].CssClass = "acs-col"; // ACS Quantity Done
                }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="gsm_maint_suspend.aspx.cs" Inherits="vtsadm.gsm_maint_suspend" EnableEventValidation="false" %>
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>GSM ID</label>
                            <div class="input-group input-group-sm">
                                <input type="text" id="txtGsmID" runat="server" class="form-control" placeholder="Please select ..." readonly="readonly" />
                                <span class="input-group-btn">
                                    <button id="Button3" runat="server" type="button" class="btn btn-block btn-primary btn-xs" data-toggle="modal" data-target="#modal-gsm"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
            ...
            <div class="col-md-4 col-xs-12">                
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <%--<asp:TextBox ID="txtDate" runat="server" class="form-control" placeholder="Date ..." ReadOnly="true"></asp:TextBox>--%>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Remark</label>
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">New GSM Information</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>GSM ID</label>
                            <div class="input-group input-group-sm">
                                <input type="text" id="txtNewGsmID" runat="server" class="form-control" placeholder="Please select ..." readonly="readonly" />
                                <span class="input-group-btn">
                                    <button id="Button1" runat="server" type="button" class="btn btn-block btn-primary btn-xs" data-toggle="modal" data-target="#modal-gsmnew"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>MSIDN</label>
                            <input type="text" id="txtNewMSIDN" runat="server" class="form-control" placeholder="MSIDN ..." readonly="readonly" />
                            <%--<asp:TextBox ID="txtNewMSIDN" runat="server" class="form-control" placeholder="MSIDN ..." ReadOnly="true"></asp:TextBox>--%>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Provider Name</label>
                            <input type="text" id="txtNewProviderName" runat="server" class="form-control" placeholder="Provider Name ..." readonly="readonly" />
                            <%--<asp:TextBox ID="txtNewProviderName" runat="server" class="form-control" placeholder="Provider Name ..." ReadOnly="true"></asp:TextBox>--%>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Source Name</label>
                            <input type="text" id="txtNewSourceName" runat="server" class="form-control" placeholder="Source Name ..." readonly="readonly" />
                            <%--<asp:TextBox ID="txtNewSourceName" runat="server" class="form-control" placeholder="Source Name ..." ReadOnly="true"></asp:TextBox>--%>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Tgt ID</label>
                            <input type="text" id="txtNewTgtID" runat="server" class="form-control" placeholder="Tgt ID ..." readonly="readonly" />
                            <%--<asp:TextBox ID="txtNewTgtID" runat="server" class="form-control" placeholder="Tgt ID ..." ReadOnly="true"></asp:TextBox>--%>
                        </div>
                        <div class="form-group form-group-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm" style="overflow: hidden;">
                            <iframe src="gsm_maint_upload.aspx" style="width: 100%; border: none; height: 370px; overflow: hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-job_order">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="gsm_maint_suspend_job_order_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-gsm">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframegsm" src="gsm_maint_suspend_gsm_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-gsmnew">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">New Gsm</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframenewgsm" src="gsm_maint_new_gsm_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        ...
        function postJobOrderChild(sJobID, sRegDate, sFullName, sPoID, sDeviceTypeDesc, sSchDate, sPoliceNo, objCmd, sCustID) {
            if (sJobID != '') {
                ...
                var cmdSearch = objfr.document.getElementById('CmdSearchGsm');
        ...
        function postGsmChild(sGsmID, sMSIDN, sProviderName, sGsmSourceName, sPoliceNo, sNoSN, objSelect, sTgtID,
            sVehicleID, sVehicleDesc, sAssetNo, sTvaID, sBranchName_Cust, sCustName, sTechnicianID, sEmployeeNo, sEmployeeName,
            sBranchName_Technician, sDeviceID, sVendorName, sDeviceTypeDesc, sDeviceSourceName, sWarehouseName, sTdtID, sInstallDate, sRemark, sTvdID) {
            if (sGsmID != '') {
        ...
        function postNewGsmChild(sTgtID, sGsmID, sMSIDN, sProviderName, sSourceName) {
            if (sGsmID != '') {
                document.getElementById('ContentPlaceHolder1_txtNewGsmID').value = checkNbsp(sGsmID);
                document.getElementById('ContentPlaceHolder1_txtNewMSIDN').value = checkNbsp(sMSIDN);
                document.getElementById('ContentPlaceHolder1_txtNewProviderName').value = checkNbsp(sProviderName);
                document.getElementById('ContentPlaceHolder1_txtNewSourceName').value = checkNbsp(sSourceName);
                document.getElementById('ContentPlaceHolder1_txtNewTgtID').value = checkNbsp(sTgtID);

                $('#modal-gsmnew').modal('hide');

...
namespace vtsadm
{
    public partial class gsm_maint_upload : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                if (Session["ClsTypeGsmMaintPicture"].ToString() != "")
                {
                    ImgInstall.ImageUrl = "~/Picture/" + Session["ClsTypeGsmMaintPicture"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG")
                    {
                        ...
                        Session["ClsTypeGsmMaintPicture"] = strFileName;

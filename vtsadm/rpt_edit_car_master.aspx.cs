...
namespace vtsadm
{
    public partial class rpt_edit_car_master : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptJobCarMasterFieldSort";
        string sViewStateDirSort = "RecRptJobCarMasterDirSort";
        string sSessionRecList = "RecRptJobCarMaster";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_edit_car_master '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Edit Car Master", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

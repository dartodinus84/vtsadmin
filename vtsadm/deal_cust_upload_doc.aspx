<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deal_cust_upload_doc.aspx.cs" Inherits="vtsadm.deal_cust_upload_doc" %>
                ...
                <div class="box box-solid" style="background-color: #f7f7f7;">
                    <div class="box-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <label>Select Files (PDF, DOC, DOCX, XLS, XLSX)</label>
                                                <asp:FileUpload ID="FileUpload1" runat="server" />
                                                <asp:TextBox ID="ImageText" runat="server" CssClass="hidden" AllowMultiple="true" />
                                            </div>
                                            <div class="form-group col-lg-12">
                        ...
                        <div class="box-footer">
                            ...
                            <input type="hidden" id="hdnFileToRemove" runat="server" />

                            <div class="file-list">
                                <div id="attachmentsList" runat="server"></div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            function removeFile(fileName) {
                if (confirm('Are you sure you want to remove this file?')) {
                    document.getElementById('<%= hdnFileToRemove.ClientID %>').value = fileName;
                    document.getElementById('<%= CmdRemove.ClientID %>').click();
                }
            }

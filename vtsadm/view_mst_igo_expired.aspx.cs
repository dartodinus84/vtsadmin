...
namespace vtsadm
{
    public partial class view_mst_igo_expired : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewExpiredFieldSort";
        string sViewStateDirSort = "RecViewExpiredDirSort";
        string sSessionRecList = "RecViewExpired";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "usp_retail_gsm_internal_expired '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUVIEWIGOEXP"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewExpired"] as System.Data.DataSet;

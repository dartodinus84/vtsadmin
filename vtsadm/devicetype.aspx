<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="devicetype.aspx.cs" Inherits="vtsadm.devicetype" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Device Type</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtDevTypeID" runat="server" class="form-control" placeholder="Device Type ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Device Brand</label>
                            <asp:TextBox ID="txtDevBrand" runat="server" class="form-control" placeholder="Device Brand ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Device Model</label>
                            <asp:TextBox ID="txtDevModel" runat="server" class="form-control" placeholder="Device Model ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Device Type Description</label>
                            <asp:TextBox ID="txtDevTypeDesc" runat="server" class="form-control" placeholder="Device Type Description ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Device Group Description</label>
                            <asp:DropDownList ID="CmbDeviceGroupID" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Device Type</h3>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DeviceBrand" HeaderText="Device Brand" ItemStyle-Wrap="false" SortExpression="DeviceBrand"></asp:BoundField>
                                        <asp:BoundField DataField="DeviceModel" HeaderText="Device Model" ItemStyle-Wrap="false" SortExpression="DeviceModel"></asp:BoundField>
                                        <asp:BoundField DataField="DeviceTypeDesc" HeaderText="Device Type Description" ItemStyle-Wrap="false" SortExpression="DeviceTypeDesc"></asp:BoundField>
                                        <asp:BoundField DataField="DeviceGroupID" HeaderText="Device Group ID" ItemStyle-Wrap="false" SortExpression="DeviceGroupID"></asp:BoundField>
                                        <asp:BoundField DataField="DeviceGroupDesc" HeaderText="Device Group Description" ItemStyle-Wrap="false" SortExpression="DeviceGroupDesc"></asp:BoundField>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label id="LblDeviceTypeID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtDeviceTypeIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblDeviceTypeID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtDeviceTypeIDDelete').value = sText;

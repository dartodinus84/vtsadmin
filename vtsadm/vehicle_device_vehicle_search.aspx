<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vehicle_device_vehicle_search.aspx.cs" Inherits="vtsadm.vehicle_device_vehicle_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="text" id="txtSearchVehicle" runat="server" class="form-control" placeholder="Search By Police No ..." />
            ...
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AssetNo" HeaderText="Asset No" ItemStyle-Wrap="true"></asp:BoundField>
                        <asp:BoundField DataField="BranchName" HeaderText="Branch Name" ItemStyle-Wrap="true"></asp:BoundField>
                        <asp:BoundField DataField="CustName" HeaderText="Customer Name" ItemStyle-Wrap="true"></asp:BoundField>
                        <asp:BoundField DataField="UplineName" HeaderText="Upline Name" ItemStyle-Wrap="true"></asp:BoundField>
                        <asp:BoundField DataField="MasterName" HeaderText="Master Name" ItemStyle-Wrap="true"></asp:BoundField>

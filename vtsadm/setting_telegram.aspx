<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="setting_telegram.aspx.cs" Inherits="vtsadm.setting_telegram" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Telegram Group</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Telegram Group</h3>
                        <div class="box-tools">
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowEditing="GridView1_RowEditing" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnSorting="GridView1_Sorting" >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="CustomerTypeDesc" HeaderText="Customer Type" ItemStyle-Wrap="false" SortExpression="CustomerTypeDesc"></asp:BoundField>
                                        <asp:BoundField DataField="BranchName" HeaderText="Customer Branch" ItemStyle-Wrap="false" SortExpression="BranchName"></asp:BoundField>
                                        <asp:BoundField DataField="telegram_id" HeaderText="TelegramID" ItemStyle-Wrap="false" SortExpression="telegram_id"></asp:BoundField>
                                        <asp:BoundField DataField="nama" HeaderText="Name" ItemStyle-Wrap="false" SortExpression="nama"></asp:BoundField>
                                        <asp:BoundField DataField="groupBotID" HeaderText="Group BotID" ItemStyle-Wrap="false" SortExpression="groupBotID"></asp:BoundField>

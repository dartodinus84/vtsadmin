...
namespace vtsadm
{
    public partial class customer_jurnal_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "usp_list_customer_search_jurnal '" + sFullName + "'";
               ...
               if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "parent.postCustChild('" + e.Row.Cells[2].Text.ToString() + "','" + e.Row.Cells[4].Text.ToString() + "'," +
                                              "'" + e.Row.Cells[3].Text.ToString() + "','" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "');return false;";

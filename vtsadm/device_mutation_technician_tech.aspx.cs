...
namespace vtsadm
{
    public partial class device_mutation_technician_tech : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_device_mutation_technician '" + Session["ClsTypeUserTechnicianID"].ToString() + "','" + txtSearch.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUMUTDEVTECH2"))
                {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "confirmDelete('" + e.Row.Cells[9].Text.ToString() + "','" + e.Row.Cells[10].Text.ToString() + "','" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[11].Text.ToString() + "','" + e.Row.Cells[14].Text.ToString() + "','" + e.Row.Cells[6].Text.ToString() + "'); return false;";
        ...
        protected void CmdYesDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtTdtIDDelete.Value.Trim() != "" && txtTdwIDDelete.Value.Trim() != "")
                {
                    strSQL = "sp_delete_device_mutation_technician '" + txtTdtIDDelete.Value.Trim() + "','" + txtTdwIDDelete.Value.Trim() + "','" + txtDeviceIDDelete.Value.Trim() + "','" + txtWareIDDelete.Value.Trim() + "','" + txtTechIDDelete.Value.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";

...
namespace vtsadm
{
    public partial class mst_intp_news_image : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                ...
                {
                    ImgInstall.ImageUrl = "~/Picture/intp/news/image/" + Session["ClsTypeNewsImage"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 4) == "JPEG" || ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "PNG")
                    {
                        ...
                        string strFullPathThumb = Server.MapPath("~/Picture/intp/news/image/") + strFileName;
                        ...
                        ImgInstall.ImageUrl = "~/Picture/intp/news/image/" + strFileName;
                        Session["ClsTypeNewsImage"] = "https://vtsadmin.easygo-gps.co.id/picture/intp/news/image/" + strFileName;

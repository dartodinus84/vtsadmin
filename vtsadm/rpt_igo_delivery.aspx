<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_igo_delivery.aspx.cs" Inherits="vtsadm.rpt_igo_delivery" EnableEventValidation="false" %>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Master - Delivery</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">

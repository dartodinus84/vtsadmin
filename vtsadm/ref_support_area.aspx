<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ref_support_area.aspx.cs" Inherits="vtsadm.ref_support_area" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Support Area ID</label>
                            <asp:TextBox ID="txtSupportAreaID" runat="server" class="form-control" placeholder="Skip for new Area ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Group Support Area</label>
                             <asp:DropDownList ID="CmbGroupSupportAreaID" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Area Support Name</label>
                            <asp:TextBox ID="txtSupportAreaName" runat="server" class="form-control" placeholder="Area Name ..." required="required"></asp:TextBox>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Support Area</h3>
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="SupAreaID" HeaderText="Support Area ID" ItemStyle-Wrap="false" SortExpression="SupAreaID"></asp:BoundField>
                                        <asp:BoundField DataField="AreaGroupID" HeaderText="Area Group ID" ItemStyle-Wrap="false" SortExpression="AreaGroupID"></asp:BoundField>
                                        <asp:BoundField DataField="SupportName" HeaderText="Support Name" ItemStyle-Wrap="false" SortExpression="SupportName"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Area Support ID :&nbsp;</h6>
                        <label id="LblSupportAreaID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtSupportAreaIDDelete" runat="server" />
                        <input type="hidden" id="txtSupportStatusDelete" runat="server" />
                    </div>
                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblSupportAreaID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtSupportAreaIDDelete').value = sText;
                document.getElementById('ContentPlaceHolder1_txtSupportStatusDelete').value = sStatus;

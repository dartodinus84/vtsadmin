<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="param_settings_customer_search.aspx.cs" Inherits="vtsadm.param_settings_customer_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="text" id="txtSearchCompany" runat="server" class="form-control" placeholder="Search By Company ID or Param Type ..." />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_job_maint_uns_approve.aspx.cs" Inherits="vtsadm.view_job_maint_uns_approve" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">View</a></li>
            <li><a href="#">Job Order Maintenance - Uninstall</a></li>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Job Order Maintenance - Uninstall</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">

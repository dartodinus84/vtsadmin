...
namespace vtsadm
{
    public partial class req_transfer_approve_device : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_header_transfer_approve_device '" + txtSearch.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUAPPTFDEV"))
                {
        ...
        protected void CmdYesSubmit_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                int qtydevicefinal = Convert.ToInt32(txtQtyFinalDevice.Text.Trim());

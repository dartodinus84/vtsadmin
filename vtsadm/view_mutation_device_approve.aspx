<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_mutation_device_approve.aspx.cs" Inherits="vtsadm.view_mutation_device_approve" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                                ...
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <HeaderTemplate>
                                                <input type="checkbox" class="bulk-approve-select-all" title="Select all devices on this page" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ChkApproveSelected" runat="server" CssClass="bulk-approve-item" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                    ...
                    <div class="box-footer">
                        ...
                        <asp:Panel ID="PnlBulkApprove" runat="server" Style="display: inline;">
                            <asp:Button ID="CmdApproveSelected" CssClass="btn btn-primary" runat="server" OnClick="CmdApproveSelected_Click" OnClientClick="return confirmBulkApproval();" Text="Approve Selected" />
                        </asp:Panel>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete request Device ID :&nbsp;</h6>
                        <label id="LblDeviceID2" runat="server"></label>
                        &nbsp;?
        ...
        <div class="modal fade" id="modal-approve">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to Approve Device ID :&nbsp;</h6>
                        <label id="LblDeviceID3" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtDeviceIDApprove" runat="server" />
                    </div>
                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sDeviceID) {
            if (sDeviceID != '') {
                document.getElementById('ContentPlaceHolder1_LblDeviceID2').innerHTML = sDeviceID;
                document.getElementById('ContentPlaceHolder1_txtDeviceIDDelete').value = sDeviceID;
                $("#modal-delete").modal('show');
            }
        }
        function confirmApprove(sDeviceID) {
            if (sDeviceID != '') {
                document.getElementById('ContentPlaceHolder1_LblDeviceID3').innerHTML = sDeviceID;
                document.getElementById('ContentPlaceHolder1_txtDeviceIDApprove').value = sDeviceID;
                $("#modal-approve").modal('show');
            }
        }
        function updateBulkApproveButton() {
            var selectedCount = $('.bulk-approve-item input:checked, input.bulk-approve-item:checked').length;
            var button = $('#<%= CmdApproveSelected.ClientID %>');
            if (button.length) {
                button.prop('disabled', selectedCount === 0);
            }
        }
        function initializeBulkApproval() {
            $('.bulk-approve-select-all').off('change.bulkApprove').on('change.bulkApprove', function () {
                $('.bulk-approve-item input, input.bulk-approve-item').prop('checked', this.checked);
                updateBulkApproveButton();
            });
            $('.bulk-approve-item input, input.bulk-approve-item').off('change.bulkApprove').on('change.bulkApprove', function () {
                var items = $('.bulk-approve-item input, input.bulk-approve-item');
                $('.bulk-approve-select-all').prop('checked', items.length > 0 && items.filter(':checked').length === items.length);
                updateBulkApproveButton();
            });
            updateBulkApproveButton();
        }
        function confirmBulkApproval() {
            ...
            return window.confirm('Are you sure to approve ' + selectedCount + ' selected device(s)?');
        }

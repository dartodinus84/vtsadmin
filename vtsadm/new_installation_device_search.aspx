<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new_installation_device_search.aspx.cs" Inherits="vtsadm.new_installation_device_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="hidden" id="txtJobID" runat="server" value="" />
                <input type="hidden" id="txtTechnicianID" runat="server" value="" />
            ...
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DeviceBrand" HeaderText="Device Brand" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="DeviceModel" HeaderText="Device Model" ItemStyle-Wrap="false"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="ContractTime" HeaderText="Contract Time" ItemStyle-Wrap="false"></asp:BoundField>
                    </Columns>

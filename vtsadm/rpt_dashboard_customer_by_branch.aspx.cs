...
namespace vtsadm
{
    public partial class rpt_dashboard_customer_by_branch : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_dashboard_customer__ListCustomerTMS_by_branch '" + ddBranch.SelectedItem.Value.Trim() + "','" + ddStatus.SelectedItem.Value.Trim() + "'";

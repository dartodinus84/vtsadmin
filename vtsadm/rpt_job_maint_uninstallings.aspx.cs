...
namespace vtsadm
{
    public partial class rpt_job_maint_uninstallings : System.Web.UI.Page
    {
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_job_maint_uninstalling_news '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "','" + CmbDeviceType.SelectedItem.Value.Trim() + "','" + CmbBranch.SelectedItem.Value.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNURPTJOBMAINTUNS"))
                {

    ...
    public partial class device : System.Web.UI.Page
    {
        ...
        protected void GridView2_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            try
            {
                ...
                sIMEI = (e.CommandSource as GridView).Rows[iRow].Cells[2].Text.Trim();
                sGMT = (e.CommandSource as GridView).Rows[iRow].Cells[3].Text.Trim();
                sDateArrival = (e.CommandSource as GridView).Rows[iRow].Cells[4].Text.Trim();
                sStatus = (e.CommandSource as GridView).Rows[iRow].Cells[12].Text.Trim();

                sVendorID = (e.CommandSource as GridView).Rows[iRow].Cells[16].Text.Trim();
                sVendorAddress = (e.CommandSource as GridView).Rows[iRow].Cells[17].Text.Trim();
                sDeviceTypeID = (e.CommandSource as GridView).Rows[iRow].Cells[18].Text.Trim();
                sDeviceGroupID = (e.CommandSource as GridView).Rows[iRow].Cells[19].Text.Trim();
                sSourceID = (e.CommandSource as GridView).Rows[iRow].Cells[20].Text.Trim();
                sServerID = (e.CommandSource as GridView).Rows[iRow].Cells[21].Text.Trim();
                sIsMobileID = (e.CommandSource as GridView).Rows[iRow].Cells[22].Text.Trim();
                sPackingListNo = (e.CommandSource as GridView).Rows[iRow].Cells[23].Text.Trim();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="gsm_mutation_technician.aspx.cs" Inherits="vtsadm.gsm_mutation_technician" EnableEventValidation="false" %>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Upload [<a href="Export/gsm_mutation_upload_final.csv">Download Template</a>]</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">

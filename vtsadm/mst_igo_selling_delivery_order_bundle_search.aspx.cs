...
namespace vtsadm
{
    public partial class mst_igo_selling_delivery_order_bundle_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_igo_master_order_delivery_bundle_search '" + sName + "'";

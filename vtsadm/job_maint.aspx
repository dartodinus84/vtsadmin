<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="job_maint.aspx.cs" Inherits="vtsadm.job_maint" EnableEventValidation="false"%>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtMarketing" runat="server" class="form-control" placeholder="Branch Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="box box-solid">
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    ...
                    <div class="box-footer">
                        ...
                        <button id="CmdUpload" type="button" class="btn btn-primary" runat="server" onclick="return showUploads();">Upload</button>

...
namespace vtsadm
{
    public partial class gsm_maint : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (CmdSubmit.Text.ToUpper() == "SUBMIT")
                {
                    if (txtJobID.Value.Trim() != "" && txtVehicleID.Value.Trim() != "" && txtDeviceID.Value.Trim() != "" && txtNewGsmID.Value.Trim() != "")
                    {
                        ...
                        {
                            strSQL = "sp_insert_gsm_maint_new '" + txtTvdID.Value.Trim() + "','" + txtTvaID.Value.Trim() + "','" + txtTdtID.Value.Trim() + "'," +
                                  "'" + txtTgtID.Value.Trim() + "','" + txtNewTgtID.Value.Trim() + "','" + txtGsmID.Value.Trim() + "','" + txtNewGsmID.Value.Trim() + "'," +
                                  "'" + txtTechnicianID.Value.Trim() + "','" + Session["ClsTypeUserTechnicianID"].ToString() + "','" + txtJobID.Value.Trim() + "','" + txtDate.Value.Trim() + "'," +
                                  "'" + CmbStatusOldGsm.SelectedItem.Value.Trim() + "','" + txtNewRemark.Text.ToString() + "'," +
                                  "'" + Session["ClsTypeGsmMaintPicture"].ToString() + "','" + Session["ClsTypeUserID"].ToString() + "'";
                            ...
                            {
                                string sErrRollback = "";
                                strSQL = "sp_insert_gsm_maint_rollback '" + txtTvdID.Value.Trim() + "'";
                                ec.Execute(strSQL, Session["ClsTypeDBConnStringSQL"].ToString().Trim(), ref intAff, ref sErrRollback);
                                div_comment.InnerHtml = "<div class='alert alert-danger alert-dismissible'><h4><i class='icon fa fa-ban'></i> Failed!</h4>Saving gsm maintenance has been failed (" + sErr + ")</div>";
                            }
                        }
                        else
                        {

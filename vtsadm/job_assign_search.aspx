<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="job_assign_search.aspx.cs" Inherits="vtsadm.job_assign_search" %>
        ...
        <div class="box-body">
            <div class="form-group form-group-sm">
                <div class="input-group input-group-sm">
                    <label>JO Group Description</label>
                    <asp:DropDownList ID="CmbJobGroup" runat="server" CssClass="form-control"></asp:DropDownList>
                </div>
            </div>
            <div class="form-group form-group-sm">
                <div class="input-group input-group-sm">
            ...
            <div class="form-group form-group-sm">
                <asp:Panel runat="server" ScrollBars="Auto">
                    <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="4" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                        <FooterStyle BackColor="White" ForeColor="#000066" />
                        <Columns>
                            <asp:BoundField DataField="JobID" HeaderText="Job ID" ItemStyle-Wrap="true"></asp:BoundField>
                            <asp:BoundField DataField="RegDate" HeaderText="Reg Date" ItemStyle-Wrap="true"></asp:BoundField>
                            <asp:BoundField DataField="FullName" HeaderText="Customer Name" ItemStyle-Wrap="true"></asp:BoundField>
                            <asp:BoundField DataField="PoID" HeaderText="Po ID" ItemStyle-Wrap="true"></asp:BoundField>
                            <asp:BoundField DataField="DeviceTypeDesc" HeaderText="Device Type" ItemStyle-Wrap="true"></asp:BoundField>
                            <asp:BoundField DataField="ScheduleDate" HeaderText="Schedule Date" ItemStyle-Wrap="true"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="CustID" HeaderText="Customer ID" ItemStyle-Wrap="true"></asp:BoundField>
                        </Columns>

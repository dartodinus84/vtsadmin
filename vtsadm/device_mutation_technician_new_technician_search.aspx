<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_mutation_technician_new_technician_search.aspx.cs" Inherits="vtsadm.device_mutation_technician_new_technician_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                ...
                <input type="hidden" id="txtBranchID" runat="server" class="form-control"/>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mst_igo_sales_order_gsm_voucher_search.aspx.cs" Inherits="vtsadm.mst_igo_sales_order_gsm_voucher_search" %>
        ...
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-btn">
                    <button id="CmdSearchJobOrder" runat="server" type="button" class="btn btn-block btn-primary btn-xs" onserverclick="CmdSearchStock_ServerClick"><i class="fa fa-search"></i></button>
                </span>
            </div>
        </div>
        <div class="form-group form-group-sm">

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_mst_igo_car_master.aspx.cs" Inherits="vtsadm.view_mst_igo_car_master" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Installation Car Master           
                <small>View</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li><a href="#">View</a></li>
            <li class="active">Installation Car Master</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Installation Car Master</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="cust_id" HeaderText="Customer ID" ItemStyle-Wrap="false" SortExpression="order_id"></asp:BoundField>
                                        <asp:BoundField DataField="customer_name" HeaderText="Customer Name" ItemStyle-Wrap="false" SortExpression="seller_cust_name"></asp:BoundField>
                                        <asp:BoundField DataField="ref_customer_name" HeaderText="Ref Customer Name" ItemStyle-Wrap="false" SortExpression="ref_customer_name"></asp:BoundField>
                                        <asp:BoundField DataField="msisdn" HeaderText="Serial Number" ItemStyle-Wrap="false" SortExpression="seller_cust_name"></asp:BoundField>
                                        <asp:BoundField DataField="car_plate" HeaderText="Car Plate" ItemStyle-Wrap="false" SortExpression="seller_cust_email"></asp:BoundField>
                                        <asp:BoundField DataField="gsm_no" HeaderText="GSM" ItemStyle-Wrap="false" SortExpression="seller_cust_phone"></asp:BoundField>
                                        <asp:BoundField DataField="active_date" HeaderText="Active Date" ItemStyle-Wrap="false" SortExpression="active_date"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="exp_warranty" HeaderText="Expired Warranty" ItemStyle-Wrap="false" SortExpression="exp_warranty"></asp:BoundField>
                                    </Columns>

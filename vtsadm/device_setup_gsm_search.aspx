<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_setup_gsm_search.aspx.cs" Inherits="vtsadm.device_setup_gsm_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="text" id="txtSearchGsm" runat="server" class="form-control" placeholder="Search By No SN ..."/>

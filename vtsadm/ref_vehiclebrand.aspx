<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ref_vehiclebrand.aspx.cs" Inherits="vtsadm.ref_vehiclebrand" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Brand Vehicle</li>
        </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Brand Vehicle Information</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Vehicle ID</label>
                            <asp:TextBox ID="txtVehicleBrandID" runat="server" class="form-control" placeholder="Skip for new Vehicle Brand ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Vehicle Brand</label>
                            <asp:TextBox ID="txtBrandVehicle" runat="server" class="form-control" placeholder="Vehicle Brand Name ..." required="required"></asp:TextBox>
                        </div>
                        <%--<div class="form-group form-group-sm">
                            <label>Type Vehicle</label>
                            <asp:TextBox ID="txtTypeVehicle" runat="server" class="form-control" placeholder="Type Vehicle Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Model Vehicle</label>
                            <asp:TextBox ID="txtModelVehicle" runat="server" class="form-control" placeholder="Type Vehicle Name ..." required="required"></asp:TextBox>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Brand Vehicle</h3>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BrandVehicle" HeaderText="Vehicle Brand" ItemStyle-Wrap="false" SortExpression="BrandVehicle"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Brand Vehicle ID :&nbsp;</h6>
                        <label id="LblVehicleBrandID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtVehicleBrandIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblVehicleBrandID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtVehicleBrandIDDelete').value = sText;

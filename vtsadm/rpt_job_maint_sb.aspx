<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_job_maint_sb.aspx.cs" Inherits="vtsadm.rpt_job_maint_sb" EnableEventValidation="false" %>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="regdate" HeaderText="Register Date" ItemStyle-Wrap="false" SortExpression="regdate"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="dtmupd_job_header" HeaderText="Date Update" ItemStyle-Wrap="false"></asp:BoundField>
                                    </Columns>
                    ...
                    <div class="box-footer">
                        ...
                        <asp:Button ID="CmdExportXls" CssClass="btn btn-primary" runat="server" OnClientClick="showOverlay();" OnClick="CmdExportXls_Click" Text="Export XLS" />
                    </div>
                </div>
            </div>
        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_job_cust_blocked_approve.aspx.cs" Inherits="vtsadm.view_job_cust_blocked_approve" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">View</a></li>
            <li><a href="#">Job Order Customer - Blocked</a></li>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="group.aspx.cs" Inherits="vtsadm.group" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtGroupID" runat="server" class="form-control" placeholder="Group ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Group ID :&nbsp;</h6><label id="LblGroupIDDelete" runat="server"></label>&nbsp;?
                        <input type="hidden" id="txtGroupIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sGroupID, sStatus) {
            if (sGroupID != '') {
                document.getElementById('ContentPlaceHolder1_LblGroupIDDelete').innerHTML = sGroupID;
                document.getElementById('ContentPlaceHolder1_txtGroupIDDelete').value = sGroupID;

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fms_package_v2.aspx.cs" Inherits="vtsadm.fms_package_v2" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtPackageID" runat="server" class="form-control" placeholder="Package ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sPackageID, sStatus) {
            if (sGroupID != '') {

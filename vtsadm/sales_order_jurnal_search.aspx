<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sales_order_jurnal_search.aspx.cs" Inherits="vtsadm.sales_order_jurnal_search" %>
            ...
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="sales_order_id" HeaderText="Sales Order ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="company_id" HeaderText="Company ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="person_id" HeaderText="Person ID Jurnal" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="person_name" HeaderText="Customer Name" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="person_address" HeaderText="Customer Address" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="person_email" HeaderText="Customer Email" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="product_name" HeaderText="Product Name" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="amount" HeaderText="Amount" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="qty" HeaderText="Qty" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="tags" HeaderText="Tags" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="gps_type" HeaderText="Gps type" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="shipping_date" HeaderText="shipping_date" ItemStyle-Wrap="false"></asp:BoundField>
                    </Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_job_cust_unblock.aspx.cs" Inherits="vtsadm.view_job_cust_unblock" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order - Customer - Unblocked
                <small>View</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Job Order - Customer - Unblocked</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="UnblockID" HeaderText="Unblock ID" ItemStyle-Wrap="false" SortExpression="UnblockID"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="UnblockedID" HeaderText="Unblocked ID" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField DataField="sUnblockedDate" HeaderText="Unblocked Date" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField DataField="RemarkUnblocked" HeaderText="Remark Unblocked" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField DataField="UsrUpdUnblocked" HeaderText="User Update" ItemStyle-Wrap="false"></asp:BoundField>
                                        <asp:BoundField DataField="DtmUpdUnblocked" HeaderText="Date Update" ItemStyle-Wrap="false"></asp:BoundField>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Job Order Customer Unblocked Details</h4>
                    </div>
                    <div class="modal-body" style="background-color: #ecf0f5">
                        <div class="row">
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group form-group-sm">
                                            ...
                                            <p id="LblUnblockID" runat="server" class="form-control-static"></p>
                                        </div>
                                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-4">
                                <div class="box box-solid">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Unblocked Info</h3>
                                    </div>
                                    <div class="box-body">
                                        <div class="form-group form-group-sm">
                                            <label>Unblocked Date</label>
                                            <p id="LblUnblockedDate" runat="server" class="form-control-static"></p>
                                        </div>
                                        <div class="form-group form-group-sm">
                                            <label>Unblocked Remark</label>
                                            <textarea id="txtUnblockedRemark" runat="server" class="form-control" style="background-color:white;" rows="1" disabled></textarea>
                                        </div>
                                        <div class="form-group form-group-sm">
    ...
    <script type="text/javascript">
        ...
        function postDetails(sUnblockID, sReqDate, sCustomerName, sSchDate, sValueStatus, objDetails, objPic, sCustID, sRemark, 
                             sUsrUpd, sDtmUpd, sUnblockedID, sUnblockedDate, sRemarkUnblocked, sUsrUpdUnblocked, sDtmUpdUnblocked, sPictureFile) {
            if (sUnblockID != '') {
                document.getElementById('ContentPlaceHolder1_LblUnblockID').innerText = CheckNbsp(sUnblockID);
                ...
                document.getElementById('ContentPlaceHolder1_LblUnblockedDate').textContent = CheckNbsp(sUnblockedDate);
                document.getElementById('ContentPlaceHolder1_txtUnblockedRemark').textContent = CheckNbsp(sRemarkUnblocked);
                document.getElementById('ContentPlaceHolder1_LblUsrUpd').textContent = CheckNbsp(sUsrUpdUnblocked);
                document.getElementById('ContentPlaceHolder1_LblDtmUpd').textContent = CheckNbsp(sDtmUpdUnblocked);

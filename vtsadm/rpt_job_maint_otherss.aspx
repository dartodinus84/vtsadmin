<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_job_maint_otherss.aspx.cs" Inherits="vtsadm.rpt_job_maint_otherss" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order - Maintenance - Others
                <small>Report</small>
        </h1>
        <ol class="breadcrumb">

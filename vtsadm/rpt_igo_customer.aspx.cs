...
namespace vtsadm
{
    public partial class rpt_igo_customer : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptMstCusFieldSort";
        string sViewStateDirSort = "RecRptMstCusDirSort";
        string sSessionRecList = "RecRptMstCus";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_igo_master_customer '" + txtSearch.Text.Trim() + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsType ClType = new ClsType();
                if (!Session["ClsTypeAccessMenu"].ToString().ToUpper().Contains("MNUIGORPTCUS"))
                {
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Report iGO Tracker - Customer ", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpt_job_maint_devices.aspx.cs" Inherits="vtsadm.rpt_job_maint_devices" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order - Maintenance - Devices 
                <small>Report</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="dtmupd_jo_header" HeaderText="Date" ItemStyle-Wrap="false" SortExpression="dtmupd_jo_header"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="DeviceTypeDesc" HeaderText="Device Name" ItemStyle-Wrap="false" SortExpression="DeviceTypeDesc"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="NoSN_Old" HeaderText="No SN Old" ItemStyle-Wrap="false" SortExpression="NoSN_Old"></asp:BoundField>
                                        <asp:BoundField DataField="DeviceTypeDesc_Old" HeaderText="Device Name Old" ItemStyle-Wrap="false" SortExpression="DeviceTypeDesc_Old"></asp:BoundField>
                                        <asp:BoundField DataField="Remark_Jo_Header" HeaderText="Remark" ItemStyle-Wrap="false" SortExpression="Remark_Jo_Header"></asp:BoundField>

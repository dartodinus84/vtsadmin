<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ref_area.aspx.cs" Inherits="vtsadm.ref_area" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Area ID</label>
                            <asp:TextBox ID="txtAreaID" runat="server" class="form-control" placeholder="Skip for new Area ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Group Area</label>
                             <asp:DropDownList ID="CmbGroupAreaID" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="CmbGroupAreaID_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Region</label>
                             <asp:DropDownList ID="CmbSupAreaID" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" DataKeyNames="AreaID,AreaGroupID,SupAreaID,AreaName,Status" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    <FooterStyle BackColor="White" ForeColor="#000066" />
                                    <Columns>
                                        <asp:BoundField DataField="AreaID" HeaderText="Area ID" ItemStyle-Wrap="false" SortExpression="AreaID"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="Region" HeaderText="Region" ItemStyle-Wrap="false" SortExpression="Region"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Area ID :&nbsp;</h6>
                        <label id="LblAreaID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtAreaIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblAreaID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtAreaIDDelete').value = sText;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_customer_search.aspx.cs" Inherits="vtsadm.customer_customer_search" %>
        ...
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-btn">
                    <button id="CmdSearchCust" runat="server" type="button" class="btn btn-primary btn-xs" onserverclick="CmdSearchCust_Click"><i class="fa fa-search"></i></button>
                </span>
            </div>
        </div>
        <div class="form-group form-group-sm">

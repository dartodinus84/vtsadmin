<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vehicle_assign_master.aspx.cs" Inherits="vtsadm.vehicle_assign_master" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Vehicle Assignment - Master  
                <small>Input</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Upline Information</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Upline ID</label>
                            <div class="input-group input-group-sm">
                                <input type="text" id="txtUplineID" runat="server" class="form-control" placeholder="Please select ..." readonly="readonly" required="required" />
                                <span class="input-group-btn">
                                    <button id="Button3" runat="server" type="button" class="btn btn-block btn-primary btn-xs" data-toggle="modal" data-target="#modal-upline"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Upline Name</label>
                            <asp:TextBox ID="txtUplineFullName" runat="server" class="form-control" placeholder="Upline Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Upline Customer Type</label>
                            <asp:TextBox ID="txtUplineCustTypeDesc" runat="server" class="form-control" placeholder="Upline Customer Type ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Upline Branch Name</label>
                            <asp:TextBox ID="txtUplineBranchName" runat="server" class="form-control" placeholder="Upline Branch Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Master Available</h3>
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Master Selected</h3>
                        <div class="box-tools" style="width: 150px;">
                            <div class="input-group input-group-sm">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="vehicle_assign_master_customer_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-vehicle">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframevehicle" src="vehicle_assign_master_vehicle_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Upline</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframeupline" src="vehicle_assign_master_upline_search.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        ...
        function postVehChild(sVehicleID, sVehicleDesc, sPoliceNo, sAssetNo, sTvaID) {
            if (sVehicleID != '') {
                ...
                var objfr2 = document.getElementById('iframeupline').contentWindow;
                var objTvaID = objfr2.document.getElementById('txtTvaID');
                var cmdSearchUpline = objfr2.document.getElementById('CmdSearchUpline');
                objTvaID.value = sTvaID;
                cmdSearchUpline.click();
            }
        }

        function postUplineChild(sUplineID, sUplineName, sUplineCustTypeDesc, sUplineBranchName) {
            if (sUplineID != '') {
                document.getElementById('ContentPlaceHolder1_txtUplineID').value = sUplineID;
                document.getElementById('ContentPlaceHolder1_txtUplineFullName').value = sUplineName;
                document.getElementById('ContentPlaceHolder1_txtUplineCustTypeDesc').value = sUplineCustTypeDesc;
                document.getElementById('ContentPlaceHolder1_txtUplineBranchName').value = sUplineBranchName;

                $('#modal-upline').modal('hide');

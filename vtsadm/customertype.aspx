<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="customertype.aspx.cs" Inherits="vtsadm.customertype" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Customer Type Information</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>Customer Type ID</label>
                            <asp:TextBox ID="txtCustTypeID" runat="server" class="form-control" placeholder="Customer Type ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Customer Type Description</label>
                            <asp:TextBox ID="txtCustTypeDesc" runat="server" class="form-control" placeholder="Customer Type Description ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="CustTypeID" HeaderText="Customer Type ID" ItemStyle-Wrap="false" SortExpression="CustTypeID"></asp:BoundField>
                                        <asp:BoundField DataField="CustTypeDesc" HeaderText="Customer Type Description" ItemStyle-Wrap="false" SortExpression="CustTypeDesc"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Customer Type ID :&nbsp;</h6>
                        <label id="LblCustTypeID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtCustTypeIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblCustTypeID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtCustTypeIDDelete').value = sText;

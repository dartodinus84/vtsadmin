<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_mutation_readycheck_device_search.aspx.cs" Inherits="vtsadm.device_mutation_readycheck_device_search" %>
        ...
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:BoundField DataField="TdwID" HeaderText="TdwID ID" ItemStyle-Wrap="false"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="WarehouseBranchID" HeaderText="Warehouse Branch ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="WarehouseBranchName" HeaderText="Warehouse Branch Name" ItemStyle-Wrap="false"></asp:BoundField>

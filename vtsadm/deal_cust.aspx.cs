...
namespace vtsadm
{
    public partial class deal_cust : System.Web.UI.Page
    {
        ...
        private void clear()
        {
            ...
            {
                ClsType ClType = new ClsType();
                ClType.Open_Combos(CmbDealStatusID, Session["ClsTypeDBConnStringSQL"].ToString(), "", "sp_list_deal_status");
        ...
        protected void CmdClear_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                clear();
                Open_GridViews(GridView2, "sp_get_deal_customer_detail", txtJobActivityID.Value.ToString(), "RecListDealCustDetail", LblPaging);
                div_comment.InnerHtml = "";
            }
            catch (Exception ex)
            {
        ...
        protected void CmdYesSubmit_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string addressLocation = Convert.ToString(txtAddressLocation.Value);
                ...
                if (CmdSubmit.Text.ToUpper() == "SUBMIT")
                {
                    ...
                    if (txtJobActivityID.Value.Trim() != "" && txtPICName.Value.Trim() != "")
                    {
                        ...
                        strSQL = "sp_submit_deal_customer " + jobactivityid + ",'" + activitydate + "','" + followupdate + "','" + remark + "'," +
                                   "'" + CmbDealStatusID.SelectedItem.Value.ToString() + "','" + picturesList + "','" + attachmentsList + "','" + latitude + "','" + longitude + "','" + addressLocation + "','" + Session["ClsTypeUserID"].ToString() + "'";
        ...
        protected void CmdYesDelete_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtActivityIDDelete.Value.Trim() != "")
                {
                    ...
                    {
                        strSQL = "sp_delete_deal_customer '" + txtActivityIDDelete.Value.Trim() + "','" + Session["ClsTypeUserID"].ToString() + "'";

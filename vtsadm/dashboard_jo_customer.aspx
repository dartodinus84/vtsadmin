<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="dashboard_jo_customer.aspx.cs" Inherits="vtsadm.dashboard_jo_customer" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Dashboard
        <small>Job Order Customer</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                         ...
                         <div class="form-group form-group-sm">
                             <label>Support Area Name</label>
                             <asp:DropDownList ID="CmbSupportAreaName" runat="server" CssClass="form-control"></asp:DropDownList>
                         </div>
        ...
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-footer no-padding">
                        <ul class="nav nav-stacked">
                            <li style="height: 46px;"><a href="view_job_customer_create_open.aspx">Open <span id="LblCntJoNewOpen" runat="server" class="pull-right badge bg-aqua">0</span></a></li>
                            <li style="height: 46px;"><a href="view_job_customer_create_close.aspx">Close<span id="LblCntJoNewClose" runat="server" class="pull-right badge bg-green">0</span></a></li>
            ...
            <div class="col-lg-4 col-xs-12">
                <div class="box box-solid">
                    ...
                    <div class="box-footer no-padding">
                        <ul class="nav nav-stacked">
                            <li style="height: 46px;"><a href="view_job_customer_maint_open.aspx">Open <span id="LblCntJoMaintOpen" runat="server" class="pull-right badge bg-aqua">0</span></a></li>
                            <li style="height: 46px;"><a href="view_job_customer_maint_close.aspx">Close<span id="LblCntJoMaintClose" runat="server" class="pull-right badge bg-green">0</span></a></li>

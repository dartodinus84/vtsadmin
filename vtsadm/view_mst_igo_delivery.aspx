<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_mst_igo_delivery.aspx.cs" Inherits="vtsadm.view_mst_igo_delivery" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">View</a></li>
            <li class="active">Delivery Bundle</li>
        </ol>
    </section>
        ...
        <div class="modal fade" id="modal-view">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to view code Order Detail ID :&nbsp;</h6>
                        <label id="LblIdsID2" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtLblIdsIDView" runat="server" />
                    </div>
                    <div class="modal-footer">
                    </div>
                </div>

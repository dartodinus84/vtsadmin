<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mst_igo_selling_delivery_order_bundle_gsm_renewal_search.aspx.cs" Inherits="vtsadm.mst_igo_selling_delivery_order_bundle_gsm_renewal_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="text" id="txtSearchJobOrder" runat="server" class="form-control" placeholder="Search By GPS SN..." />
            ...
            <asp:Panel runat="server" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="order_type_desc" HeaderText="Order Type Desc" ItemStyle-Wrap="false" SortExpression="order_type_desc"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="SellerName" HeaderText="Seller Name" ItemStyle-Wrap="false" SortExpression="SellerName"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="seller_cust_phone" HeaderText="Customer Address" ItemStyle-Wrap="false" SortExpression="seller_cust_address"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="quantity" HeaderText="Quantity" ItemStyle-Wrap="false" SortExpression="SourceMarketing"></asp:BoundField>
                        <asp:BoundField DataField="resi" HeaderText="Recipt Expedition" ItemStyle-Wrap="false" SortExpression="resi"></asp:BoundField>
                        <asp:BoundField DataField="expedition_id" HeaderText="Expedition" ItemStyle-Wrap="false" SortExpression="expedition_id"></asp:BoundField>
                        <asp:BoundField DataField="picture" HeaderText="Picture" ItemStyle-Wrap="false" SortExpression="picture"></asp:BoundField>
                        <asp:BoundField DataField="picture_recipt" HeaderText="Picture Recipt" ItemStyle-Wrap="false" SortExpression="picture_recipt"></asp:BoundField>

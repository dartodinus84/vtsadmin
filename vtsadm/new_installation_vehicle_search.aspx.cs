...
namespace vtsadm
{
    public partial class new_installation_vehicle_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_new_installation_vehicle_search '" + txtCustID.Value.Trim() + "','" + sPoliceNo + "'";

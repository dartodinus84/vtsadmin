...
namespace vtsadm
{
    public partial class rpt_sum_device : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecRptSummaryDeviceFieldSort";
        string sViewStateDirSort = "RecRptSummaryDeviceDirSort";
        string sSessionRecList = "RecRptSummaryDevice";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_rpt_summary_device_warehouse '" + txtSearch.Text.Trim() + "','" + CmbWarehouse.SelectedItem.Value.Trim() + "'";
        ...
        private void clear()
        {
            try
            {
                ClsType ClType = new ClsType();
                txtSearch.Text = "";
                ClType.Open_Combos(CmbWarehouse, Session["ClsTypeDBConnStringSQL"].ToString(), "", "[sp_list_warehouse]");
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Stock Of Name - Device", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="job_maint_technician.aspx.cs" Inherits="vtsadm.job_maint_technician" EnableEventValidation="false"%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Job Order <small>Maintenance</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <input type="text" id="txtCustID" runat="server" class="form-control" placeholder="Please select ..." readonly="readonly" required="required" disabled="disabled" />
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Full Name</label>
                            <asp:TextBox ID="txtCustFullName" runat="server" class="form-control" placeholder="Full Name ..." required="required" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Customer Type</label>
                            <asp:TextBox ID="txtCustTypeDesc" runat="server" class="form-control" placeholder="Customer Type ..." required="required" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Branch Name</label>
                            <asp:TextBox ID="txtCustBranchName" runat="server" class="form-control" placeholder="Branch Name ..." required="required" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Marketing</label>
                            <asp:TextBox ID="txtMarketing" runat="server" class="form-control" placeholder="Branch Name ..." required="required" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                    <div class="box box-solid">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <input type="date" id="txtRegDate" runat="server" class="form-control" placeholder="Register Date ..." disabled="disabled"/>
                            <%--<asp:TextBox ID="txtRegDate" TextMode="Date" runat="server" class="form-control" placeholder="Register Date ..."></asp:TextBox>--%>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Billable</label>
                            <asp:DropDownList ID="CmbBillAble" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Migration</label>
                            <asp:DropDownList ID="CmbMigration" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Area</label>
                            <asp:DropDownList ID="CmbArea" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Schedule Date</label>
                            <input type="date" id="txtScheduleDate" runat="server" class="form-control" placeholder="Schedule Date ..." disabled="disabled"/>
                        ...
                        <div class="form-group form-group-sm">
                            <label>Notes</label>
                            <asp:TextBox ID="txtNotes" runat="server" class="form-control" placeholder="Notes ..." TextMode="MultiLine" Rows="3"></asp:TextBox>
                        </div>
                    </div>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDeleting="GridView1_RowDeleting" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowEditing="GridView1_RowEditing" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnSorting="GridView1_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Marketing" HeaderText="Marketing" ItemStyle-Wrap="false"></asp:BoundField>
                                    </Columns>
                                    <RowStyle ForeColor="#003481" BackColor="White" />
                                    <SelectedRowStyle BackColor="LightBlue" Font-Bold="True" ForeColor="#6298ff" />
                                    <PagerStyle Wrap="true" CssClass="pagination-ys" ForeColor="#003481" HorizontalAlign="Left" BorderColor="White" />
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to submit Job ID :&nbsp;</h6><label id="LblJobIDSubmit" runat="server"></label>&nbsp;?
                    </div>
        ...
        <div class="modal fade" id="modal-delete-header">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Job ID :&nbsp;</h6><label id="LblJobID" runat="server"></label>&nbsp;?
        ...
        <div class="modal fade bs-example-modal-lg" id="modal-upload">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="job_maint_upload.aspx" style="width: 100%; border: none; height: 460px;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal modal-open fade" id="modal-details" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframedetails" src="job_maint_details.aspx" style="width: 100%; border: none; height: 700px; overflow:hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                </div>
                <!-- /.modal-content -->
    ...
    <script type="text/javascript">
        ...
        function postCustChild(sCustID, sFullName, sCustTypeDesc, sBranchName, sMarketing) {
            if (sCustID != '') {
                ...
                document.getElementById('ContentPlaceHolder1_txtMarketing').value = sMarketing;
            }
        }

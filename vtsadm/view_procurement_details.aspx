<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_procurement_details.aspx.cs" Inherits="vtsadm.view_procurement_details" %>
        ...
        <div class="form-group form-group-sm">
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:BoundField DataField="PurID" HeaderText="Purcahse Order ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="DeviceGroupID" HeaderText="Tools Group" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="ToolsTypeDesc" HeaderText="Tools Desc" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Quantity" HeaderText="Quantity" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="QuantityDone" HeaderText="Quantity Done" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="Price" HeaderText="Price / Item" ItemStyle-Wrap="false"></asp:BoundField>

...
namespace vtsadm
{
    public partial class view_job_deal : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewJobDealFieldSort";
        string sViewStateDirSort = "RecViewJobDealDirSort";
        string sSessionRecList = "RecViewJobDeal";
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_view_job_deal '" + txtSearch.Text.Trim() + "','" + filterType + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
                ViewState[sViewStateFieldSort] = "JobActivityID";
        ...
        private void clear()
        {
            ...
            {
                ClsType ClType = new ClsType();
                ClType.Open_Combos(CmbFilterType, Session["ClsTypeDBConnStringSQL"].ToString(), "", "sp_list_jobdeal_filter");
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (clType.ExportToCsvTab(Rec, "Job Deal", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdFunc.OnClientClick = "postFunc('" + e.Row.Cells[17].Text.ToString() + "'); return false;";

...
namespace vtsadm
{
    public partial class view_auth_customer : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    CmdButton.OnClientClick = "postDetails('" + e.Row.Cells[0].Text.ToString() + "','" + e.Row.Cells[1].Text.ToString() + "'," +
                                              ...
                                              "'" + e.Row.Cells[14].Text.ToString() +  "'); return false;";
                
                    LinkButton CmdPic = (LinkButton)e.Row.FindControl("CmdPic");
                    CmdPic.OnClientClick = "postPic('" + e.Row.Cells[12].Text.ToString() + "'); return false;";

                    LinkButton CmdFav = (LinkButton)e.Row.FindControl("CmdFavicon");
                    CmdFav.OnClientClick = "postFavicon('" + e.Row.Cells[13].Text.ToString() + "'); return false;";

                    LinkButton CmdBackground = (LinkButton)e.Row.FindControl("CmdBackground");
                    CmdBackground.OnClientClick = "postBackground('" + e.Row.Cells[14].Text.ToString() + "'); return false;";
                    */

...
namespace vtsadm
{
    public partial class mst_igo_selling_delivery_order_voucher_search : System.Web.UI.Page
    {
        ...
        {
            ClsType ClType = new ClsType();
            string strSQL = "sp_list_igo_master_order_delivery_voucher_search '" + sName + "'";

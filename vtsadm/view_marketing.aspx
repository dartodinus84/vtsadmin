<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_marketing.aspx.cs" Inherits="vtsadm.view_marketing" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="MarketingID" HeaderText="Technician ID" ItemStyle-Wrap="false" SortExpression="MarketingID"></asp:BoundField>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Log Marketing</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe id="iframelog" src="view_marketing_log.aspx" style="width: 100%; border: none; height: 350px;" scrolling="no"></iframe>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function postLog(sMarketingID) {
            if (sMarketingID != '') {
                $('#modal-log').modal('show');
                var objfr = document.getElementById('iframelog').contentWindow;
                var objMarketingID = objfr.document.getElementById('txtMarketingID');
                var cmdSearchLog = objfr.document.getElementById('CmdSearchLog');
                objMarketingID.value = sMarketingID;
                cmdSearchLog.click();
            }
        }
        function postDetails(sMarketingID, sEmployeeNo, sName, sBranchName, sStatus, sBranchID, sBranchAddress) {
            if (sMarketingID != '') {

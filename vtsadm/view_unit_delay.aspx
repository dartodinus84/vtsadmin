<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="view_unit_delay.aspx.cs" Inherits="vtsadm.view_unit_delay" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">View Unit Delay</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Unit Delay</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="10" OnRowDataBound="GridView2_RowDataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ServerID" HeaderText="ServerID" ItemStyle-Wrap="false" SortExpression="ServerID"></asp:BoundField>
                                        <asp:BoundField DataField="gps_time" HeaderText="Gps Time" ItemStyle-Wrap="false" SortExpression="gps_time" DataFormatString="{0:yyyy-dd-MM hh:mm:ss}"></asp:BoundField>
                                        <asp:BoundField DataField="acc" HeaderText="Acc" ItemStyle-Wrap="false" SortExpression="acc"></asp:BoundField>
                                        <asp:BoundField DataField="last_acc_on" HeaderText="Last Acc On" ItemStyle-Wrap="false" DataFormatString="{0:yyyy-dd-MM hh:mm:ss}"></asp:BoundField>
                                        <asp:BoundField DataField="last_acc_off" HeaderText="Last Acc Off" ItemStyle-Wrap="false" DataFormatString="{0:yyyy-dd-MM hh:mm:ss}"></asp:BoundField>
                                        <asp:BoundField DataField="report_nm" HeaderText="Event" ItemStyle-Wrap="false" SortExpression="report_nm"></asp:BoundField>
                                        <asp:BoundField DataField="gsm_no" HeaderText="No GSM" ItemStyle-Wrap="false" SortExpression="gsm_no"></asp:BoundField>
                                        <asp:BoundField DataField="gps_model" HeaderText="Gps Type" ItemStyle-Wrap="false" SortExpression="gps_model"></asp:BoundField>

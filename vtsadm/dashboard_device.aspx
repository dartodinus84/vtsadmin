<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="dashboard_device.aspx.cs" Inherits="vtsadm.dashboard_device" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-dashboard"></i>Device</a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-blue-gradient">
                    <div class="inner">
                        <h3>
                            <label id="lblDeviceRG" runat="server">1,000</label>
                        </h3>
                        <p>Registered</p>
                    </div>
                    <div class="icon">
                    ...
                    <a href="rpt_sum_device.aspx" class="small-box-footer">Details <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-green-gradient">
                    <div class="inner">
                        <h3>
                            <label id="lblDeviceMW" runat="server">1,000</label>
                        </h3>
                        <p>Warehouse</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-yellow-gradient">
                    <div class="inner">
                        <h3>
                            <label id="lblDeviceMT" runat="server">1,000</label>
                        </h3>
                        <p>Technician</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-maroon-gradient">
                    <div class="inner">
                        <h3>
                            <label id="lblDeviceIS" runat="server">1,000</label>
                        </h3>
                        <p>Installed</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-teal-gradient">
                    <div class="inner">
                        <h3>
                            <label id="lblDeviceBR" runat="server">1,000</label>
                        </h3>
                        <p>Brooken</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-purple-gradient">
                    <div class="inner">
                        <h3>
                            <label id="lblDeviceDE" runat="server">1,000</label>
                        </h3>
                        <p>Deactivated</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-9 col-xs-12">
                <div class="box box-solid">
                    <div class="box-header bg-gray-light">
                        ...
                        Device Status by Warehouse
                    </div>
                    <div class="box-body">
                        <div id="chartDeviceStatusWarehouse">
                            <!--style="height: 200px;"-->
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div id="chartDeviceTechnicianJkt" style="height: 175px;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div id="chartDeviceTechnicianSby" style="height: 170px;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div id="chartDeviceTechnicianPdg" style="height: 170px;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div id="chartDeviceTechnicianSmg" style="height: 170px;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div id="chartDeviceTechnicianPlb" style="height: 170px;">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function endRequest(sender, args) {
            ...
            createChart(chart, "dashboard_device.aspx/DeviceWarehouse", "");

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="fms_package.aspx.cs" Inherits="vtsadm.fms_package" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtPackageID" runat="server" CssClass="form-control" placeholder="Select App ID first ..."></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Package Name</label>
                            <asp:TextBox ID="txtPackageName" runat="server" class="form-control" placeholder="Package Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Package Description</label>
                            <asp:TextBox ID="txtPackageDesc" runat="server" class="form-control" placeholder="Package Description ..."></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Package</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PackageDesc" HeaderText="Description" ItemStyle-Wrap="false" SortExpression="PackageDesc"></asp:BoundField>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="CmdYesSubmit" runat="server" CssClass="btn btn-default" Text="Yes" OnClick="CmdYesSubmit_ServerClick" OnClientClick="$('#modal-submit').modal('hide'); return true;" />
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Package ID :&nbsp;</h6><label id="LblPackageIDDelete" runat="server"></label>&nbsp;?
                        <input type="hidden" id="txtPackageIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sAppID, sPackageID, sStatus) {
            if (sPackageID != '') {
                document.getElementById('ContentPlaceHolder1_LblPackageIDDelete').innerHTML = sPackageID;
                document.getElementById('ContentPlaceHolder1_txtPackageIDDelete').value = sPackageID;
        ...
        function showPackageMessage() {
            var modalMsg = document.getElementById('ContentPlaceHolder1_div_comment');

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vendor.aspx.cs" Inherits="vtsadm.vendor" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Vendor Maintenance           
                <small>Input</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtVendorID" runat="server" class="form-control" placeholder="Skip for new vendor ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label id="LblVendorID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtVendorIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblVendorID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtVendorIDDelete').value = sText;

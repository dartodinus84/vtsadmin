<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="auth_user.aspx.cs" Inherits="vtsadm.auth_user" EnableEventValidation="false" %>
    ...
    <section class="content">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            <label>User ID</label>
                            <asp:DropDownList ID="CmbUserID" runat="server" AutoPostBack="true" OnTextChanged="CmbUserID_TextChanged" CssClass="form-control"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Full Name</label>
                            <asp:TextBox ID="txtFullName" runat="server" class="form-control" placeholder="Full Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Email</label>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtUserType" runat="server" class="form-control" placeholder="User Type ..."></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:DropDownList ID="CmbGroupID" AutoPostBack="true" OnTextChanged="CmbGroupID_TextChanged" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Group Name</label>
                            <asp:TextBox ID="txtGroupName" runat="server" class="form-control" placeholder="Group Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">List User Authentication</h3>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="GroupID" HeaderText="Group ID" ItemStyle-Wrap="false" SortExpression="GroupID"></asp:BoundField>
                                        <asp:BoundField DataField="GroupName" HeaderText="Group Name" ItemStyle-Wrap="false" SortExpression="GroupName"></asp:BoundField>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete authentication User ID :&nbsp;</h6>
                        <label id="LblUserIDDelete" runat="server"></label>
                        &nbsp;?

...
namespace vtsadm
{
    public partial class cs_survey_question_company_search : Page
    {
        private const string SessionGridKey = "RecListCsSurveyQuestionCompanySearch";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            cmdButton.OnClientClick = "parent.selectSurveyCompany('" + companyId + "','" + companyName + "');return false;";
        }
    }
}

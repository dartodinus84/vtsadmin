<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="postdeal_cust.aspx.cs" Inherits="vtsadm.postdeal_cust" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Customer <small>Post Deal</small></h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-6 col-xs-12">
                <div id="box-jo" class="box box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Job Post Deal Information</h3>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Job Post Deal</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group form-group-sm">
                            <iframe src="postdeal_cust_job_postdeal_search.aspx" style="width: 100%; border: none; height: 350px; overflow: hidden;" scrolling="no"></iframe>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            const radios = document.querySelectorAll('#<%= rblClosingStatus.ClientID %> input[type="radio"]');
            radios.forEach((radio, index) => {
                if (radio.value === 'NO') {
                    radio.parentElement.classList.add('my-no-class');
                } else if (radio.value === 'YES') {
                    radio.parentElement.classList.add('my-yes-class');
                }
            });
        };
        ...
        function postJobDealChild(sJobActivityID, sJobActivityCode, sReqDate, sFullName, sProductName, sCustID, sCustBranchName, sBusinessFieldID, sPicName, sPicPhone, sMarketingName) {

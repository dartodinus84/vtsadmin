<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pr_dlo_create_details.aspx.cs" Inherits="vtsadm.pr_dlo_create_details" %>
...
<body>
    <form id="form1" runat="server">
        <div class="box-body">
            ...
            <div class="form-group form-group-sm">
                <label>Quantity Undone (dari PO)</label>
                <asp:TextBox ID="txtQuantityUndone" runat="server" class="form-control" placeholder="Pilih Device Type ..." ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group form-group-sm">
                <div class="row">
                    <div class="col-xs-3">
            ...
            <div class="form-group form-group-sm">
                <div class="row">
                    <div class="col-xs-4">
                        <label>Price (dari PO)</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-4">
                        <input type="text" id="txtPrice" runat="server" class="form-control" placeholder="Pilih Device Type ..." ReadOnly="true" />
                    </div>
                </div>
            </div>
        </div>

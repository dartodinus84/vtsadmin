<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_mutation_warehouse_new_warehouse_search.aspx.cs" Inherits="vtsadm.device_mutation_warehouse_new_warehouse_search" %>
    ...
    <form id="form1" runat="server">
        <div class="form-group form-group-sm">
            <div class="input-group input-group-sm">
                <input type="text" id="txtSearchWarehouse" runat="server" class="form-control" placeholder="Search By Name ..." />
                <span class="input-group-btn">
                    <button id="CmdSearchWarehouse" runat="server" type="button" class="btn btn-block btn-primary btn-xs" onserverclick="CmdSearchWarehouse_Click"><i class="fa fa-search"></i></button>
                </span>
            </div>
        </div>
        <div class="form-group form-group-sm">

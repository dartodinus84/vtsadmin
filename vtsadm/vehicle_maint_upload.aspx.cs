...
namespace vtsadm
{
    public partial class vehicle_maint_upload : System.Web.UI.Page
    {
        ...
        protected void Clear()
        {
            try
            {
                if (Session["ClsTypeVehicleMaintPicture"].ToString() != "")
                {
                    ImgInstall.ImageUrl = "~/Picture/" + Session["ClsTypeVehicleMaintPicture"].ToString();
                }
                else
                {
                    ImgInstall.ImageUrl = "";
            ...
            try
            {
                ...
                if (FileUpload1.FileName != "")
                {
                    if (ClsFunc.Right(FileUpload1.FileName.ToUpper().Trim(), 3) == "JPG")
                    {
                        ...
                        Session["ClsTypeVehicleMaintPicture"] = strFileName;

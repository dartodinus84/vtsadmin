<%@ Page Title=".:: EasyGo ::. VTS Administration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="branch.aspx.cs" Inherits="vtsadm.branch" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtBranchID" runat="server" class="form-control" placeholder="Branch ID ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Branch Name</label>
                            <asp:TextBox ID="txtBranchName" runat="server" class="form-control" placeholder="Branch Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Address</label>
                    ...
                    <%--                    <div class="box-comment" id="div_comment" runat="server">
                    </div>--%>
                </div>
            </div>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools" style="width: 150px;">
                            <div class="input-group input-group-sm">
                                <asp:TextBox ID="txtSearch" runat="server" class="form-control pull-right" placeholder="Search by branch name ..."></asp:TextBox>
        ...
        <div class="modal fade" id="modal-delete">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">Are you sure to delete Branch ID :&nbsp;</h6>
                        <label id="LblBranchID" runat="server"></label>
                        &nbsp;?
                        <input type="hidden" id="txtBranchIDDelete" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function confirmDelete(sText, sStatus) {
            if (sText != '') {
                document.getElementById('ContentPlaceHolder1_LblBranchID').innerHTML = sText;
                document.getElementById('ContentPlaceHolder1_txtBranchIDDelete').value = sText;

...
namespace vtsadm
{
    public partial class view_mst_igo_delivery_gsm_perdana : System.Web.UI.Page
    {
        string sViewStateFieldSort = "RecViewPerdanaFieldSort";
        string sViewStateDirSort = "RecViewPerdanaDirSort";
        string sSessionRecList = "RecViewPerdana";
        ...
        protected void Open_GridView()
        {
            try
            {
                ...
                string strSQL = "sp_list_igo_master_delivery_perdana '" + txtSearch.Text.Trim() + "','" + txtDateFrom.Text.Trim() + "','" + txtDateTo.Text.Trim() + "'";
        ...
        protected void CmdExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Rec.RecData = Session["RecViewPerdana"] as System.Data.DataSet;
                if (Rec.RecordCount() > 0)
                {
                    if (clType.ExportToCsvTab(Rec, " Perdana ", strFullPath.Trim(), 50000, ref sMsg))
                    {
                        Response.Clear();
        ...
        private void sendEmail(string orderid)
        {
            ...
            try
            {
                var pageData = new view_mst_igo_delivery_gsm_perdana();

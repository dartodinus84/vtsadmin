<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="telegram.aspx.cs" Inherits="vtsadm.telegram" EnableEventValidation="false" %>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <div class="form-group form-group-sm">
                            ...
                            <asp:TextBox ID="txtTelegramID" runat="server" class="form-control" placeholder="Skip for new Telegram ..." required="required" disabled=""></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Telegram Account Name</label>
                            <asp:TextBox ID="txtTelegramName" runat="server" class="form-control" placeholder="Telegram Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Telegram Account ID</label>
                            <asp:TextBox ID="txtAccountID" runat="server" class="form-control" placeholder="Telegram Name ..." required="required"></asp:TextBox>
                        </div>
                        <div class="form-group form-group-sm">
                            <label>Telegram Number Phone</label>
                            <asp:TextBox ID="txtNumberPhone" runat="server" class="form-control" placeholder="Telegram Name ..." required="required"></asp:TextBox>
                        </div>
                         <div class="form-group form-group-sm">
                            <label>Telegram Chat ID</label>
                            <asp:TextBox ID="txtChatId" runat="server" class="form-control" placeholder="Telegram Name ..." required="required"></asp:TextBox>
                        </div>
                    </div>
                            ...
                            <asp:Panel runat="server" ScrollBars="Auto">
                                <asp:GridView ID="GridView2" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowCommand="GridView2_RowCommand" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowDataBound="GridView2_RowDataBound" OnSorting="GridView2_Sorting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="AccountID" HeaderText="Account ID" ItemStyle-Wrap="false" SortExpression="AccountID"></asp:BoundField>
                                        <asp:BoundField DataField="PhoneNumber" HeaderText="Phone Number" ItemStyle-Wrap="false" SortExpression="PhoneNumber"></asp:BoundField>
                                        <asp:BoundField DataField="ChatID" HeaderText="Chat ID" ItemStyle-Wrap="false" SortExpression="ChatID"></asp:BoundField>

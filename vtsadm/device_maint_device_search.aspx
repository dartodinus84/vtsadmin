<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="device_maint_device_search.aspx.cs" Inherits="vtsadm.device_maint_device_search" %>
            ...
            <asp:Panel runat="server" CssClass="" ScrollBars="Auto" Width="100%">
                <asp:GridView ID="GridView1" runat="server" BackColor="WhiteSmoke" AllowSorting="true" Font-Size="Small" CssClass="table table-bordered" CellPadding="2" Width="100%" AutoGenerateColumns="False" Font-Bold="False" CellSpacing="1" EmptyDataText="No items to display" ForeColor="#003481" GridLines="None" BorderWidth="0px" AllowPaging="True" PageSize="5" OnRowDataBound="GridView1_RowDataBound" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DeviceSourceName" HeaderText="Device Source Name" ItemStyle-Wrap="false"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="GsmSourceName" HeaderText="Gsm Source Name" ItemStyle-Wrap="false"></asp:BoundField>
                        ...
                        <asp:BoundField DataField="CustID" HeaderText="Cust ID" ItemStyle-Wrap="false"></asp:BoundField>
                        <asp:BoundField DataField="WarantyDate" HeaderText="Waranty Date" ItemStyle-Wrap="false"></asp:BoundField>
                    </Columns>
